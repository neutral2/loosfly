...
switch($mode) {
	...
	case 'get_goods' :
		...
		$ret_goods['goods_data'] = $goodsHelper->getGoodsCollectionArray($goodsCollection, $categoryModel);
	...
	case 'get_member_qna' :
		...
		$pg_member_qna->field = "distinct a.sno, a.parent, a.itemcd, a.subject, a.contents, a.ordno, a.regdt as regdt, b.m_no, b.m_id, b.name";
		...
		$pg_member_qna->setQuery($db_table,$member_qna_where,$sort="a.sno desc, a.regdt desc");
		$pg_member_qna->exec();
