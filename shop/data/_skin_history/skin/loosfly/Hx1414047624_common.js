...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function overS(tag, element) { menu_action(true, tag, element, "font-size:13px;"); };
	function outS(tag, element) { menu_action(false, tag, element, "font-size:14px;"); };

	function overM(tag, element) { menu_action(true, tag, element, "font-size:13px;"); };
	function outM(tag, element) { menu_action(false, tag, element, "font-size:14px;"); };	
	function overM_1(tag, element) { menu_action(true, tag, element, "font-size:13px; color:#f47d30"); };
