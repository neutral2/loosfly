...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function overS(tag, element) { menu_action(true, tag, element, "font-size:12px;"); };
	function outS(tag, element) { menu_action(false, tag, element, "font-size:14px;"); };

	function overM(tag, element) { menu_action(true, tag, element, "font-size:12px;"); };
	function outM(tag, element) { menu_action(false, tag, element, "font-size:14px;"); };	
	function overM_1(tag, element) { menu_action(true, tag, element, "font-size:12px; color:#f47d30"); };
	function outM_1(tag, element) { menu_action(false, tag, element, "font-size:14px; color:#f47d30;"); };

	function overL(tag, element) { menu_action(true, tag, element, "font-size:14px;"); };
	function outL(tag, element) { menu_action(false, tag, element, "font-size:16px;"); };	
	...
	function menu_action(isOver, tag, element, cssText) {
		...
		if( isOver ) 
			...
			element.style.cssText += "font-family:\"Ek Mukta\", sans-serif;";
