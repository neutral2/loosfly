...
//			break;
     ...
     */
    $LGD_CASNOTEURL				= "http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/order/card/lgdacom/cas_noteurl.php?isMobile=Y";

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */
    $LGD_RETURNURL				= "http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/order/card/lgdacom/mobile/cart_return.php";

	  /*
     * ISP 카드결제 연동중 모바일ISP방식(고객세션을 유지하지않는 비동기방식)의 경우, LGD_KVPMISPNOTEURL/LGD_KVPMISPWAPURL/LGD_KVPMISPCANCELURL를 설정하여 주시기 바랍니다. 
     */
    $LGD_KVPMISPNOTEURL       	="http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/order/card/lgdacom/mobile/cart_return.php?isAsync=Y&uid=".$_SESSION['uid'].'&m_id='.$_SESSION['sess']['m_id'];
    $LGD_KVPMISPWAPURL			="http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/order/card/lgdacom/mobile/mispwapurl.php?LGD_OID=".$LGD_OID;//ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함 
    $LGD_KVPMISPCANCELURL     	="http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/order/card/lgdacom/mobile/Cancel.php?isAsync=Y";
