...
<input type=hidden name=RtnUrl value="<? echo 'http://'.$_SERVER['SERVER_NAME'].$cfg['rootDir'].'/order/card/agspay/mobile/card_return.php' ?>">	<!-- ★성공 URL (150) - 성공 URL은 반드시 상점의 AGS_pay_ing.php의 전체 경로로 맞춰 주시기 바랍니다. ex)http://www.allthegate.com/mall/AGS_pay_ing.php -->
<input type=hidden name=CancelUrl value="<? echo 'http://'.$_SERVER['SERVER_NAME'].'/m/myp/orderview.php?ordno='.$_POST['ordno'] ?>">	<!-- ★취소 URL (150) - 객이 취소를 눌렀을 경우의 이동 URL 경로로 전체 경로로 맞춰 주시기 입니다. ex)http://www.allthegate.com/mall/AGS_pay_cancel.php -->
