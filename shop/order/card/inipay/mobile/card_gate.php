...
// 리턴 URL 설정
$P_NEXT_URL		= "http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/order/card/inipay/mobile/card_return.php?ordno=".$_POST['ordno']."&settlekind=".$_POST['settlekind'];
$P_NOTI_URL		= "http://".$_SERVER['HTTP_HOST'].$cfg['rootDir']."/order/card/inipay/mobile/vacctinput.php";
$P_RETURN_URL			= "http://".$_SERVER['HTTP_HOST'].$cfgMobileShop['mobileShopRootDir']."/ord/order_return_url.php?ordno=".$_POST['ordno'];
