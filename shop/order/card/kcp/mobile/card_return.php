...
<?
	...
	if ( $req_tx == "pay" )
    {
		...
		else if( $res_cd == "0000" )
        {
			...
			$query = "
				...
				go($cfgMobileShop['mobileShopRootDir']."/ord/order_end.php?ordno=$ordr_idxx&card_nm=$card_nm","parent");
		}
    ...
    /* ============================================================================== */
		else if ( $req_cd != "0000" )
		{
			...
			go($cfgMobileShop['mobileShopRootDir']."/ord/order_fail.php?ordno=$ordr_idxx&card_nm=$card_nm","parent");
		}
	}
