...
<input type="hidden" name='Ret_URL'      value="http://<?=$_SERVER['HTTP_HOST']?><?=$cfg['rootDir']?>/order/card/kcp/mobile/shopTouch_card_return.php">
<!-- 인증시 필요한 파라미터(변경불가)-->
...
<form name="pay_form" method="POST" action="<?=$cfg[rootDir]?>/order/card/kcp/mobile/shopTouch_card_return.php">
