...
// 리다이렉트 문제로 인하여 모바일샵은 모바일용 헤더를 사용
if (isset($_GET['isMobile'])) {
	include dirname(__FILE__).'/../../../conf/config.mobileShop.php';
	include dirname(__FILE__).'/../../../../'.$cfgMobileShop['mobileShopRootDir'].'/_header.php';
}
else {
...
$sendData['Notiurl'] = 'http://'.$domain.$shopConfig['rootDir'].'/order/card/mobilians/card_notice.php';	// 결제처리URL : 결제 완료 후, 가맹점측 과금 등 처리할 가맹점측 URL
...
if (isset($_GET['isMobile'])) {
	...
	$sendData['Closeurl'] = 'http://'.$domain.$cfgMobileShop['mobileShopRootDir'].'/ord/order.php';
}
else {
