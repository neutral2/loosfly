...
if($P_STATUS == '0021') {
	...
	$url = "http://".$_SERVER['SERVER_NAME'].$cfgMobileShop['mobileShopRootDir']."/ord/order_end.php?ordno=".$P_OID;	
} else {
	$url = "http://".$_SERVER['SERVER_NAME'].$cfgMobileShop['mobileShopRootDir']."/ord/order_fail.php";
}
