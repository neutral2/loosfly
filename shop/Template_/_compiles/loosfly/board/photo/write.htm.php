<?php /* Template_ 2.2.7 2013/12/19 14:04:13 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/board/photo/write.htm 000012616 */ ?>
...
<?php if($GLOBALS["bdSecretChk"]==""||$GLOBALS["bdSecretChk"]=="0"||$GLOBALS["bdSecretChk"]== 1){?>
	<img src="/shop/data/skin/loosfly/board/photo/img/board_secret.gif" align=absmiddle>
...
<?php if(count($TPL_VAR["file"])< 12){?>
	<tr>
		...
		<a href="javascript:add()"><img src="/shop/data/skin/loosfly/board/photo/img/btn_upload_plus.gif" align=absmiddle></a>
		</td>
		<td id=prvImg0></td>
	</tr>
<?php }?>
...
<tr height=30>
	...
	<input type="image" src="/shop/data/skin/loosfly/board/photo/img/board_btn_ok.gif" />
	<a href="javascript:document.frmWrite.reset()"><img src="/shop/data/skin/loosfly/board/photo/img/board_btn_reset.gif"></a>
	<a href="javascript:history.back()"><img src="/shop/data/skin/loosfly/board/photo/img/board_btn_back.gif"></a>
	</td>
</tr>
</table><p>
</form>
...
function add(){
	...
	tmpHTML = "<input type=file name='file[]' style='width:80%' class=line onChange='preview(this.value," + oTr.id +")'> <a href='javascript:del(" + oTr.id + ")'><img src='/shop/data/skin/loosfly/board/photo/img/btn_upload_minus.gif' align=absmiddle></a>";
