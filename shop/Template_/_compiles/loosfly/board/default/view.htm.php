<?php /* Template_ 2.2.7 2014/07/28 12:24:12 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/board/default/view.htm 000008396 */ 
...
<?php }?>
					...
					<input type=image src="/shop/data/skin/loosfly/board/default/img/board_btn_review.gif">
					</td>
				</tr>
				</table>
...
<?php }?>
			<tr>
				...
				<tr>
					<td>
<?php if($TPL_V1["link"]["modify"]){?><?php echo $TPL_V1["link"]["modify"]?><img src="/shop/data/skin/loosfly/board/default/img/board_btn_modify.gif"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
<?php if($TPL_V1["link"]["delete"]){?><?php echo $TPL_V1["link"]["delete"]?><img src="/shop/data/skin/loosfly/board/default/img/board_btn_delete.gif"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
					</td>
					<td align=right>
...
<?php if((is_array($TPL_R2=$TPL_V1["relation"]["reply"])&&!empty($TPL_R2)) || (is_object($TPL_R2) && in_array("Countable", class_implements($TPL_R2)) && $TPL_R2->count() > 0)) {foreach($TPL_R2 as $TPL_V2){?>
				<tr>
					<td height=20><?php echo $TPL_V2["gapReply"]?><?php if($TPL_V2["sub"]){?><img src="/shop/data/skin/loosfly/board/default/img/board_re.gif" align=absmiddle><?php }?><?php echo $TPL_V2["link"]["view"]?><?php echo $TPL_V2["subject"]?></a></td>
				</tr>
<?php }}?>
				</table>
