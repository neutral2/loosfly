<?php /* Template_ 2.2.7 2013/12/19 14:04:43 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/board/webzine/write.htm 000014809 */ ?>
...
<?php if($GLOBALS["bdPrivateYN"]=="Y"&&is_file(sprintf("../skin/%s/service/_private_non.txt",$GLOBALS["cfg"]["tplSkin"]))){?>
			...
			<!-- 비회원 개인정보 취급방침 내용 -->
			<div><img src="/shop/data/skin/loosfly/img/common/order_txt_non.gif" border=0></div>
...
<?php }?>
					...
					<col width="100">
					<tbody>
					<tr><td colspan="2" style="border:none;overflow:hidden;font-size:ppx;padding:0px;height:2px;background:#303030;"> </td></tr>
					<tr>
						<td align="right" class="input_txt" height="30">* 이름 :&nbsp;</td>
...
<?php if(!($TPL_VAR["readonly"]["name"]||$TPL_VAR["ici_admin"])){?>
					<tr>
						<td align="right" class="input_txt" height="30">* 비밀번호 :&nbsp;</td>
...
<?php if(!$GLOBALS["bdEmailNo"]){?>
					<tr>
						<td align="right" class="input_txt" height="30">이메일 :&nbsp;</td>
						<td class="cell_L"><input name="email" style="width:400px; border:0 none;" value="<?php echo $TPL_VAR["email"]?>" class="linebg"></td>
					</tr>
					<tr><td height="1" bgcolor="#E0DFDF" colspan="2" style="font-size:0;padding:0px;"></td></tr>
<?php }?>
<?php if(!$GLOBALS["bdHomepageNo"]){?>
					<tr>
						<td align="right" class="input_txt" height="30">홈페이지 :&nbsp;</td>
						<td class="cell_L"><input name="homepage" style="width:400px; border:0 none;" value="<?php echo $TPL_VAR["homepage"]?>" class="linebg"></td>
					</tr>
					<tr><td height="1" bgcolor="#E0DFDF" colspan="2" style="font-size:0;padding:0px;"></td></tr>
<?php }?>
<?php if($GLOBALS["bdUseSubSpeech"]){?>
					<tr>
						<td align="right" class="input_txt" height="30">* 말머리 :&nbsp;</td>
...
<?php if($GLOBALS["bdTitleCChk"]||$GLOBALS["bdTitleSChk"]||$GLOBALS["bdTitleBChk"]){?>
					<tr>
						<td align="right" class="input_txt" height="30">제목효과 :&nbsp;</td>
						<td class="cell_L">
...
<?php }?>
					<tr>
						<td align="right" class="input_txt" height="30">* 제목 :&nbsp;</td>
						<td class="cell_L"><input name="subject" style="width:400px" value="<?php echo $TPL_VAR["subject"]?>" class="linebg" required fld_esssential></td>
					</tr>
					<tr><td height="1" bgcolor="#E0DFDF" colspan="2" style="font-size:0;padding:0px;"></td></tr>
					<tr>
						<td align="right" class="input_txt" height="30">* 내용 :&nbsp;</td>
						<td class="cell_L">
						<div>
...
<?php if($GLOBALS["bdSecretChk"]==""||$GLOBALS["bdSecretChk"]=="0"||$GLOBALS["bdSecretChk"]== 1){?>
							<img src="/shop/data/skin/loosfly/board/webzine/img/board_secret.gif" align=absmiddle>
...
<?php }?>
						...
						<div style="height:550px;padding-top:5px;position:relative;z-index:99;vertical-align:middle;">
							<!-- mini editor -->
...
<?php if($GLOBALS["bdUseLink"]){?>
					<tr><td height="1" bgcolor="#E0DFDF" colspan="2" style="font-size:0;padding:0px;"></td></tr>
					<tr>
						<td align="right" class="input_txt" height="30">링크 :&nbsp;</td>
						<td class="cell_L">
						<input type="text" name="urlLink" style="width:450px;border:0 none;" value="<?php echo $TPL_VAR["urlLink"]?>" class="linebg">
						</td>
					</tr>
					<tr><td height="1" bgcolor="#E0DFDF" colspan="2" style="font-size:0;padding:0px;"></td></tr>
<?php }?>
<?php if($GLOBALS["bdUseFile"]){?>
					<tr>
						<td align="right" class="input_txt" height="30" valign="top" style="padding-top:10px">업로드 :&nbsp;</td>
						<td class="cell_L">
...
<?php if(count($TPL_VAR["file"])< 12){?>
							<tr>
								<td width="20" height="20" nowrap> 1</td>
								<td width="100%">
								<input type="file" name="file[]" style="width:80%" class="linebg" onChange="preview(this.value,0)">
								<a href="javascript:add()"><img src="/shop/data/skin/loosfly/board/webzine/img/btn_upload_plus.gif" align="absmiddle"></a>
								</td>
								<td id="prvImg0"></td>
							</tr>
<?php }?>	
...
<?php }?>
					...
					<tr height="30">
						<td id="avoidDbl" colspan="2" align="center" style="padding-top:10px">
						<input type="button" value="확인" style="width:100px;height:30px;cursor:pointer;" onclick="javascript:document.frmWrite.submit();">
						<input type="button" value="초기화" style="width:100px;height:30px;cursor:pointer;" onclick="javascript:document.frmWrite.reset()">
						<input type="button" value="뒤로가기" style="width:100px;height:30px;cursor:pointer;" onclick="javascript:history.back()">
						<!--input type="image" src="/shop/data/skin/loosfly/board/webzine/img/board_btn_ok.gif" /-->
						<!--a href="javascript:document.frmWrite.reset()"><img src="/shop/data/skin/loosfly/board/webzine/img/board_btn_reset.gif"></a-->
						<!--a href="javascript:history.back()"><img src="/shop/data/skin/loosfly/board/webzine/img/board_btn_back.gif"></a-->
						</td>
					</tr>
					</tbody>
					</table>
			...
			<script>
				...
				function add(){
					...
					tmpHTML = "<input type=file name='file[]' style='width:80%' class=line onChange='preview(this.value," + oTr.id +")'> <a href='javascript:del(" + oTr.id + ")'><img src='/shop/data/skin/loosfly/board/webzine/img/btn_upload_minus.gif' align=absmiddle></a>";
