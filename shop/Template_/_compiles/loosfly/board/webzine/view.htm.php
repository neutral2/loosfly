<?php /* Template_ 2.2.7 2013/08/19 16:13:28 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/board/webzine/view.htm 000007810 */ 
...
<table width=100% style="table-layout:fixed" cellpadding=0 cellspacing=0 align="left">
...
<?php }?>
		...
		<input type=image src="/shop/data/skin/loosfly/board/webzine/img/board_btn_review.gif">
		</td>
	</tr>
	</table>
...
<tr>
	...
	<tr>
		<td>
<?php if($TPL_V1["link"]["modify"]){?><?php echo $TPL_V1["link"]["modify"]?><img src="/shop/data/skin/loosfly/board/webzine/img/board_btn_modify.gif"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
<?php if($TPL_V1["link"]["delete"]){?><?php echo $TPL_V1["link"]["delete"]?><img src="/shop/data/skin/loosfly/board/webzine/img/board_btn_delete.gif"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
<?php if($TPL_VAR["link"]["write"]){?><?php echo $TPL_V1["link"]["reply"]?><img src="/shop/data/skin/loosfly/board/webzine/img/board_btn_reply.gif"><?php echo $TPL_VAR["link"]["end"]?><?php }?>
		</td>
		<td align=right>
		<?php echo $TPL_VAR["link"]["list"]?><img src="/shop/data/skin/loosfly/board/webzine/img/board_btn_list.gif"><?php echo $TPL_VAR["link"]["end"]?>

<?php if($TPL_VAR["link"]["write"]){?><?php echo $TPL_VAR["link"]["write"]?><img src="/shop/data/skin/loosfly/board/webzine/img/board_btn_write.gif"><?php echo $TPL_VAR["link"]["end"]?><?php }?>
		</td>
	</tr>
	</table>
...
<?php if(is_array($TPL_R2=$TPL_V1["relation"]["reply"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
	<tr>
		<td height=20><?php echo $TPL_V2["gapReply"]?><?php if($TPL_V2["sub"]){?><img src="/shop/data/skin/loosfly/board/webzine/img/board_re.gif" align=absmiddle><?php }?><?php echo $TPL_V2["link"]["view"]?><?php echo $TPL_V2["subject"]?></a></td>
	</tr>
<?php }}?>
	</table>
