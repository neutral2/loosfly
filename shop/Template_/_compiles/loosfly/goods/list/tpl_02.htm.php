<?php /* Template_ 2.2.7 2013/12/17 11:14:30 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/list/tpl_02.htm 000003333 */ 
...
<tr>
	...
	<td>
<?php if($TPL_V1["coupon"]){?><div class=eng><b style="color:red"><?php echo $TPL_V1["coupon"]?></b> <img src="/shop/data/skin/loosfly/img/icon/good_icon_coupon.gif" align=absmiddle></div><?php }?>
...
<?php if($TPL_V1["icon"]){?><?php echo $TPL_V1["icon"]?><?php }?>
	...
	<td><?php if($TPL_V1["shortdesc"]){?><div style="padding-bottom:5px" class=stxt><?php echo nl2br($TPL_V1["shortdesc"])?></div><?php }?></td>
	<td>
<?php if(!$TPL_V1["strprice"]){?>
<?php if($TPL_V1["price"]){?>
		<b style="color:#C94C00"><?php echo number_format($TPL_V1["price"])?>원<?php if($TPL_V1["special_discount_amount"]){?><img src="/shop/data/skin/loosfly/img/icon/goods_special_discount.gif"><?php }?></b>
<?php }?>
