<?php /* Template_ 2.2.7 2013/04/20 21:30:57 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/goods_grp_02.htm 000006947 */ 
$TPL__r_page_num_1=empty($GLOBALS["r_page_num"])||!is_array($GLOBALS["r_page_num"])?0:count($GLOBALS["r_page_num"]);?>
<?php $this->print_("header",$TPL_SCP,1);?>

<!-- 상단이미지 || 현재위치 -->
<TABLE width=100% cellpadding=0 cellspacing=0 border=0>
<tr>
	<td><img src="/shop/data/skin/loosfly/img/common/title_discount.gif" border=0></td>
</tr>
<TR>
...
<!-- 타이틀이미지 네임 :::
할인상품 <img src="/shop/data/skin/loosfly/img/common/title_discount.gif" border=0>
베스트상품 <img src="/shop/data/skin/loosfly/img/common/title_best.gif" border=0>
추천상품 <img src="/shop/data/skin/loosfly/img/common/title_recomgoods.gif" border=0>
-->
...
<tr>
	...
	<tr>
		...
		<td align=right><img src="/shop/data/skin/loosfly/img/common/goodlist_txt_06.gif" align=absmiddle><select onchange="this.form.page_num.value=this.value;this.form.submit()" style="font:8pt 돋움"><?php if($TPL__r_page_num_1){foreach($GLOBALS["r_page_num"] as $TPL_V1){?><option value="<?php echo $TPL_V1?>" <?php echo $GLOBALS["selected"]["page_num"][$TPL_V1]?>><?php echo $TPL_V1?>개씩 정렬<?php }}?></select></td>
	</tr>
	</table>
