<?php /* Template_ 2.2.7 2014/10/22 18:19:29 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/goods_review_list.htm 000006778 */ 
...
<!--table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/loosfly/img/common/bar_detail_03.gif) no-repeat;" nowrap width="100" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/loosfly/img/common/bar_detail_03_bg.gif) repeat-x;" width='90%'></TD>
		<TD style="background: URL(/shop/data/skin/loosfly/img/common/bar_detail_03_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
</table-->
<div style="height:30px;width:840px;background:#efefef;line-height:30px;text-align:left"><span style="margin-left:15px">이용후기 (User Review)</span></div>
...
<?php if($TPL_V1["type"]=='Q'){?>
	<td><div style="background-image: url(/shop/data/skin/loosfly/img/common/icon_review.gif); background-repeat:no-repeat;background-position:left 6px;padding:3px 0px 0px 12px;"><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["attach"]){?>&nbsp;&nbsp;<img src="/shop/data/skin/loosfly/img/disk_icon.gif" align="absmiddle"><?php }?></div></td>
<?php }else{?>
	<td style="padding-left:5px"><div style="background-image: url(/shop/data/skin/loosfly/img/common/ico_a.gif); background-repeat:no-repeat;background-position:left 3px;padding:3px 0px 0px 27px;"> <?php echo $TPL_V1["subject"]?><?php if($TPL_V1["attach"]){?>&nbsp;&nbsp;<img src="/shop/data/skin/loosfly/img/disk_icon.gif" align="absmiddle"><?php }?></div></td>
<?php }?>
...
<div style="display:none;padding:10px;border-bottom-style:solid;border-bottom-color:#E6E6E6;border-bottom-width:1px;">
	<div width="100%" style="padding-left:17px;text-align:left">
<?php if($TPL_V1["image"]!=''){?>
...
<a href="<?php echo url("goods/goods_review.php")?>&" target="_parent"><img src="/shop/data/skin/loosfly/img/common/info_btn_totalview.gif"></a>
<a href="javascript:;" onClick="popup_register( 'add_review', '<?php echo $GLOBALS["goodsno"]?>' )"><img src="/shop/data/skin/loosfly/img/common/btn_review.gif"></a>
</div>
