...
<style>
	body{margin:0 auto;font:normal 18px/47px  "나눔고딕", "Nanum Gothic", "AppleGothic", "맑은고딕", "Malgun Gothic", "돋움", "Dotum", "Sans-serif";;}
</style>
</head>
...
<table width="350" height="300" cellspacing="0" cellpadding="0" style="border:#71cbd2 solid 3px">
	<tr>
		<td height="47" width="350" bgcolor="#71cbd2" style="color:#ffffff;padding-left:20px">장바구니 담기</td>
	...
	<tr>
		<td height="180" align="center" valign="middle" style="color:#747474;font-size:20px;font-weight:bold" colspan="2" >장바구니에 담았습니다.<br/>지금 확인하시겠습니까?</td>
	</tr>	
	<tr>
