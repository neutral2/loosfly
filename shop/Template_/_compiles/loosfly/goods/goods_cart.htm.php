<?php /* Template_ 2.2.7 2013/12/16 18:54:19 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/goods_cart.htm 000004927 */ ?>
...
var nsGodo_CartAction = function() {
	...
	return {
		...
		<div id="blkContentsNoMenu">
			...
			<tr><td><img src="/shop/data/skin/loosfly/img/jimmy/titles/shoppingcart_title_01.gif"></td></tr>
			</TABLE>
			
<?php if($TPL_VAR["use_todayshop_cart"]=='y'){?>
			<a href="<?php echo url("goods/goods_cart.php")?>&"><img src="/shop/data/skin/loosfly/img/common/btn_basket_shopping.gif"></a>
			<a href="<?php echo url("goods/goods_cart.php?")?>&cart_type=todayshop"><img src="/shop/data/skin/loosfly/img/common/btn_basket_today.gif"></a>
<?php }?>
...
<?php if(count($TPL_VAR["cart"]->item)){?>
					<a href="javascript:void(0);" onClick="nsGodo_CartAction.del();return false;" onFocus="blur()"><img src="/shop/data/skin/loosfly/img/common/btn_check_delete.gif" border=0></a>&nbsp;
					<a href="javascript:void(0);" onClick="nsGodo_CartAction.order();return false;" onFocus="blur()"><img src="/shop/data/skin/loosfly/img/common/btn_check_order.gif" border=0></a>&nbsp;
					<a href="javascript:void(0);" onClick="nsGodo_CartAction.wishList();return false;" onFocus="blur()"><img src="/shop/data/skin/loosfly/img/common/btn_check_wslist.gif" border=0></a>&nbsp;
<?php }?>
				<a href="javascript:history.back();"onFocus="blur()"><img src="/shop/data/skin/loosfly/img/common/btn_back2.gif" border=0></a>&nbsp;
				<a href="<?php echo url("goods/goods_cart.php?")?>&mode=empty" onFocus="blur()"><img src="/shop/data/skin/loosfly/img/common/btn_empty2.gif" border=0></a>&nbsp;
				<a href="<?php echo url("index.php")?>&" onFocus="blur()"><img src="/shop/data/skin/loosfly/img/common/btn_continue2.gif" border=0></a>
				</td>
			</tr>
			</TABLE>
