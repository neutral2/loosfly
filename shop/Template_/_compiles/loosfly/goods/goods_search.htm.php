<?php /* Template_ 2.2.7 2013/07/08 12:02:50 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/goods_search.htm 000015000 */ ?>
					...
					<div style="border:1px solid #DEDEDE; background-color:#F5F5F5;">
						...
						<tr>
							<td style="text-align:center;padding-top:20px;">
								...
								<span class=noline><input type="image" src="/shop/data/skin/loosfly/img/common/btn_search.gif" align=absmiddle></span>
						...
						<tr>
							<td style="text-align:left;padding:5px 200px 20px 0;"><?php if($GLOBALS["s_type"]['keyword']){?>인기검색어 : <?php echo $GLOBALS["s_type"]['keyword']?><?php }?></td>
						</tr>
						</table>
					</div>
...
<?php if(is_array($TPL_R1=$GLOBALS["s_type"]['detail_type'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
										<tr>
...
<?php break;case 'add':?>
											...
											<td style="text-align:left;">
<?php if(is_array($TPL_R2=$GLOBALS["s_type"]['detail_add_type'])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
...
<?php break;case 'color':?>
											...
											<td style="text-align:left;">
												...
												<tr>
													<td>
<?php if(is_array($TPL_R2=($GLOBALS["colorList"]))&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
...
<?php }}?>
								...
								<!-- 검색 : End -->
									...
									<td style="text-align:right">
										<span class=noline><input type="image" src="/shop/data/skin/loosfly/img/common/btn_search_b.gif" align=absmiddle></span>
									</td>
								</tr>
								</table>
							</td>
...
<?php if($_GET['disp_type']=='list'){?>
										<img name="disp_list" src="/shop/data/skin/loosfly/img/common/btn_list_on.gif">
<?php }else{?>
										<img name="disp_list" src="/shop/data/skin/loosfly/img/common/btn_list_off.gif">
<?php }?>
									</a>
									<a href="javascript: add_param_submit('disp_type', 'gallery')">
<?php if($_GET['disp_type']=='gallery'){?>
										<img name="disp_gallery" src="/shop/data/skin/loosfly/img/common/btn_gallery_on.gif">
<?php }else{?>
										<img name="disp_gallery" src="/shop/data/skin/loosfly/img/common/btn_gallery_off.gif">
<?php }?>
									</a>
<?php }?>
								</td>
