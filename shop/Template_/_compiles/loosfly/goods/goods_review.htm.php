...
<?php }}?>
			...
			<div align=center style="padding:25px"><font color=555555>[이용후기를 남기고자 하는 각 상품의 상세페이지하단에 글쓰기 버튼이 있습니다]</font></div>
		</div><!-- End indiv -->
		<div style="height:15px;"></div>
	</div>
