<?php /* Template_ 2.2.7 2013/04/16 10:58:39 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/goods_preview.htm 000039359 */ 
...
<img src="/shop/data/skin/loosfly/img/common/btn_zoom.gif" onclick="popup('goods_popup_large.php?goodsno=<?php echo $TPL_VAR["goodsno"]?>',800,600)" style="cursor:pointer" align=absmiddle>
</div>
<div align=center>
	...
	return {
		...
		add : function() {
			...
			if (chkGoodsForm(form)) {
				...
				html += '<div style="padding:1 0 2 0"><img src="/shop/data/skin/loosfly/img/common/btn_multioption_ea_up.gif" onClick="nsGodo_MultiOption.ea(\'up\',\''+key+'\');" style="cursor:pointer"></div>';
				...
				// 옵션가격
				_data.opt_price = _data.price - _data.coupon;
				for (var i=0,m=_data.addopt.length;i<m ;i++ )
				{
					tmp = _data.addopt[i].split('^');
...
<div id="el-multi-option-display" class="goods-multi-option">
	...
	<div style="font-size:12px;text-align:right;padding:10px 20px 10px 0;border-bottom:1px solid #D3D3D3;margin-bottom:5px;">
		<img src="/shop/data/skin/loosfly/img/common/btn_multioption_br.gif" align="absmiddle"> 총 금액 : <span style="color:#E70103;font-weight:bold;" id="el-multi-option-total-price"></span>
	</div>
</div>
<!-- / -->
...
<?php if($TPL_VAR["clevel"]=='0'||$TPL_VAR["slevel"]>=$TPL_VAR["clevel"]){?>
<a href="javascript:act('../order/order')"><img src="/shop/data/skin/loosfly/img/common/btn_direct_buy.gif"></a>
<a href="javascript:cartAdd(frmView,'<?php echo $TPL_VAR["cartCfg"]->redirectType?>')"><img src="/shop/data/skin/loosfly/img/common/btn_cart.gif"></a>
<a href="javascript:act('../mypage/mypage_wishlist')"><img src="/shop/data/skin/loosfly/img/common/btn_wish_m_un.gif"></a>
<?php }?>
<?php }elseif($TPL_VAR["runout"]&&$TPL_VAR["use_stocked_noti"]){?>
<a href="javascript:fnRequestStockedNoti('<?php echo $TPL_VAR["goodsno"]?>');"><img src="/shop/data/skin/loosfly/img/stocked_noti/btn_alarm.gif"></a>
<?php }?>
<a href="javascript:opener.location.href='<?php echo url("goods/goods_list.php?")?>&category=<?php echo $_GET["category"]?>';self.close()"><img src="/shop/data/skin/loosfly/img/common/btn_list.gif"></a>
</div>
