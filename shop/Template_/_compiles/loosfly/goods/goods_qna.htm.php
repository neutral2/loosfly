<?php /* Template_ 2.2.7 2014/06/30 18:18:31 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/goods_qna.htm 000008248 */ 
...
<?php }?>
	<div id="blkContents">
		...
		<tr><td><img src="/shop/data/skin/loosfly/img/common/title_qna.gif" border=0></td></tr>
		</TABLE>
...
<?php }elseif($TPL_V1["type"]=='N'){?>
						<td style="padding-left:5px;cursor:pointer;" onclick="view_content('<?php echo $TPL_V1["sno"]?>')"><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["secretIcon"]){?>&nbsp;<img src="/shop/data/skin/loosfly/img/common/icn_secret.gif" align=absmiddle><?php }?></div></td>
<?php }?>
...
<?php }}?>
			...
			<a href="javascript:;" onclick="popup_register( 'add_qna', '' )"><img src="/shop/data/skin/loosfly/img/common/btn_qna.gif"></a>
			</div-->
