<?php /* Template_ 2.2.7 2014/02/26 15:38:13 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/goods_brand.htm 000007802 */ ?>
...
<?php }?>
		<div id="blkContents">
			...
			<!-- 상단이미지 -->
			<div id="bxBodyTitle">
				<?PHP if(  $GLOBALS["brand"] =='3' ) { ?>
					<img src="/shop/data/skin/loosfly/img/jimmy/top_logo_01.gif" border=0>
				<?PHP } else { ?>
			...
			<div class="indiv"><!-- Start indiv -->
				...
				<form name="frmList">
					...
					<table width=100% border=0 cellpadding=0 cellspacing=0 style="padding-left:10px">
						...
						<tr>
							<td bgcolor="9e9e9e" class="small" height="27" style="padding-left:5px">
								<table width=100% border=0 cellpadding=0 cellspacing=0>
									<tr>
										<td id="b_white"><img src="/shop/data/skin/loosfly/img/common/icon_goodalign2.gif" align=absmiddle><FONT COLOR="#FFFFFF"><b><?php echo $TPL_VAR["lstcfg"]["brandnm"]?></b>총 <b><?php echo $TPL_VAR["pg"]->recode['total']?></b>개의 상품이 있습니다.</FONT></td>
									</tr>
								</table>
							</td>
						</tr>
