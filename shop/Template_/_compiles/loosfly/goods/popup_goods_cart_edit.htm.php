<?php /* Template_ 2.2.7 2013/12/17 11:09:26 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/goods/popup_goods_cart_edit.htm 000020753 */ 
...
<img src="/shop/data/skin/loosfly/img/common/cart_option_edit_title.gif">
...
<div style="margin:15px 0 15px 0;overflow:hidden;height:1px;background:url(/shop/data/skin/loosfly/img/common/line2.gif) repeat-x top left;"></div>


<!-- 필수 옵션 일체형 -->
<?php if($GLOBALS["opt"]&&$GLOBALS["typeOption"]=="single"){?>
<div style="margin-bottom:10px;">
<span style="display:block;margin-bottom:5px;font-weight:bold;color:#565656;"><img src="/shop/data/skin/loosfly/img/common/btn_multioption_br.gif" align="absmiddle"> 옵션명 (<?php echo $TPL_VAR["optnm"]?>)</span>
...
<div style="margin-bottom:10px;">
<span style="display:block;margin-bottom:5px;font-weight:bold;color:#565656;"><img src="/shop/data/skin/loosfly/img/common/btn_multioption_br.gif" align="absmiddle"> <?php echo $TPL_K1?></span>
<div>
...
<?php if($TPL__optnm_1){$TPL_I1=-1;foreach($GLOBALS["optnm"] as $TPL_V1){$TPL_I1++;?>
	<div style="margin-bottom:10px;">
	<span style="display:block;margin-bottom:5px;font-weight:bold;color:#565656;"><img src="/shop/data/skin/loosfly/img/common/btn_multioption_br.gif" align="absmiddle"> 옵션명 <?php echo $TPL_I1+ 1?> (<?php echo $TPL_V1?>)</span>
...
<div style="margin:15px 0 5px 0;overflow:hidden;height:1px;background:url(/shop/data/skin/loosfly/img/common/line.gif) repeat-x top left;"></div>

<!-- 수량 -->
<div style="float:left;font-weight:bold;color:#565656;padding-top:6px;"><img src="/shop/data/skin/loosfly/img/common/btn_multioption_br.gif" align="absmiddle"> 수량</div>
...
<div style="padding:1 0 2 0"><img src="/shop/data/skin/loosfly/img/common/btn_multioption_ea_up.gif" onClick="chg_cart_ea(frmCartOption.ea,'up')" style="cursor:pointer"></div>
<div><img src="/shop/data/skin/loosfly/img/common/btn_multioption_ea_down.gif" onClick="chg_cart_ea(frmCartOption.ea,'dn')" style="cursor:pointer"></div>
</div>

</div>

<div style="text-align:center;padding:10px;">
	<input type="image" src="/shop/data/skin/loosfly/img/common/btn_modify.gif">
	<a href="javascript:void(0);" onClick="self.close();"><img src="/shop/data/skin/loosfly/img/common/btn_cancel3.gif"></a>
</div>
