<?php /* Template_ 2.2.7 2013/07/25 12:57:48 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/service/cooperation.htm 000005426 */ ?>
...
<tr>
	<td><img src="/shop/data/skin/loosfly/img/common/title_ad.gif" border=0></td>
</tr>
<TR>
...
<?php if(is_array($TPL_R1=codeitem('cooperation'))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_K1=>$TPL_V1){?>
...
<input type="image" src="/shop/data/skin/loosfly/img/common/btn_send.gif" border=0 align="absmiddle">
<a href="javascript:history.back();"><img src="/shop/data/skin/loosfly/img/common/btn_cancel.gif" align="absmiddle"></a>
</div>
</form>
...
location.href="http://www.loosfly.com";
</script>
