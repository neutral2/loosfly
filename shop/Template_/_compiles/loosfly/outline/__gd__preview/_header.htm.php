<?php /* Template_ 2.2.7 2014/02/27 16:04:37 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/outline/_header.htm 000004639 */ ?>
...
<?PHP 
	...
	$fname =  $TPL_VAR["pfile"];
	if(  $TPL_VAR["id"] == "notice" ) $fname="notice.php";
	else if(  $TPL_VAR["id"] == "stories" ) $fname="stories.php";
	$op1 =  currPosition($GLOBALS["category"]);

	$path = lfy_get_path($fname, $op1,  $TPL_VAR["goodsnm"]);
?>
	<div id="dsPath"><div id="blkPathIndicator"><?PHP echo $path; ?></div></div>
	<div id="dsBody">