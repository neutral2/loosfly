...
<?PHP } ?>
			...
			<div id="bxService">
				...
				<div class="menu_item"><a href="/shop/member/find_id.php"><div onMouseOver="overS('아이디 찾기', this);" onMouseOut="outS('Find My ID', this);">Find My ID</div></a></div>
		...
		<div id="blkObligation">
			...
			<legend ><span><b>[</b>통신판매사업 관련 법령에 따른 의무표시사항<b>]</b></span></legend>
				...
				<tr>
					...
					<td>사업자등록번호 : <?php echo $GLOBALS["cfg"]['compSerial']?> <a href="javascript:onopen();" target="_blank"> [확인]</a></td>
