<?php /* Template_ 2.2.7 2013/10/31 13:31:15 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/member/NewNiceIpin.htm 000002007 */ ?>
...
<tr>
	...
	<tr>
		<td align=left style="padding-right:20px"><font color='5d5d5d'>
			<img src="/shop/data/skin/loosfly/img/ipin/Regist_box_icon.gif"/> 아이핀(i-PIN)은 방송통신위원회에서 주관하는 주민등록번호 대체수단으로 회원님의 주민등록번호 대신<br>&nbsp;&nbsp;&nbsp;&nbsp;아이핀 ID를 NICE신용평가정보(주)
			로부터 발급받아 본인확인을 하는 서비스입니다.<br><br>
			<img src="/shop/data/skin/loosfly/img/ipin/Regist_box_icon.gif"/> i-PIN 인증으로 가입시 i-PIN 인증기관을 통해 실명인증을 받게 되므로<br>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $TPL_VAR["shopName"]?>에는 회원님의 주민등록번호가 저장되지 않습니다.
			</font>
		</td>
	</tr>
	</table>
