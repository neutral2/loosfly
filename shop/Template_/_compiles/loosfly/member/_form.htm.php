...
<script src="/shop/data/skin/loosfly/godo.password_strength.js" type="text/javascript"></script>
				...
				<style>
					...
					#boxScroll{overflow: auto; BACKGROUND: #ffffff; COLOR: #585858; font:9pt 돋움;border:1px #dddddd solid; overflow-x:hidden;text-align:left; }
...
<?php if($GLOBALS["cfg"]['private2YN']=='Y'){?>
					<div style="padding-top:10px; background:#f1f1f1; text-align:center;">
						<div align="left" style="height:26px;padding:3px 0 0 10px;"><b>● 개인정보 제3자 제공 관련</b></div>
...
<?php if($GLOBALS["cfg"]['private3YN']=='Y'){?>
					<div style="padding-top:10; background:#F1F1F1;  text-align:center;">
						<div align="left" style="height:26;padding:3px 0 0 10px;"><b>● 개인정보취급 위탁 관련</b></div>
...
<?php echo $TPL_VAR["naverCheckout_oneclickStep"]?>
					...
					<div><div style="color:#ff6000;float:left;width:415px;height:30px">개인회원정보</div><div style="float:right;width:415px;text-align:right;"><font color="#ff6000">※</font><font class="small"><b>필수입력사항</b></font></div></div>
...
<?php if($GLOBALS["mode"]=='modMember'){?>
										<tr>
											...
											<!-- 비밀번호 버튼 -->
											<td class="memberCols2">
												<a href="javascript:void(0);" onclick="openPasswordField()"><img src="/shop/data/skin/loosfly/img/common/btn_change_pwd.gif" align="absmiddle" alt="비밀번호 변경" /></a>
												<a href="javascript:void(0);" onclick="_ID('pwdManual').style.display='block';"><img src="/shop/data/skin/loosfly/img/common/btn_help_pwd.gif" align="absmiddle" alt="비밀번호 도움말" /></a><br />
												<!-- 비밀번호 도움말 -->
												<div id="pwdManual">
													<p>비밀번호에 영문 대소문자, 숫자, 특수문자를 조합하시면 비밀번호 안전도가 높아져 도용의 위험이 줄어듭니다.</p>
													<ul>
											...
											<td class="memberCols2">
												...
												<tr>
													...
													<td>
														...
														<span style="font-size::8pt;color:#007FC8">현재 비밀번호를 입력해 주세요.</span>
													</td>
												</tr>
												<tr>
													...
													<td>
														...
														<span style="font-size:8pt;color:#007FC8">새로 변경할 비밀번호를 입력해 주세요.</span>
													</td>
												</tr>
												<tr>
													...
													<td>
														...
														<span style="font-size:8pt;color:#007FC8">새로 변경할 비밀번호를 다시 한번 입력해 주세요.</span>
													</td>
												</tr>
												</table>
											</td>
...
<?php if(!$GLOBALS["sess"]){?>
												<input type="hidden" name="chk_email" <?php echo $GLOBALS["required"]["email"]?> label="이메일중복체크">
<?php }?>
...
<?php if($GLOBALS["checked"]["useField"]["mailling"]){?>
												<span class="noline" style="padding-left:10px"><input type=checkbox name=mailling <?php echo $GLOBALS["checked"]["mailling"]?>><span style="font-size:8pt;color:#007FC8" >정보메일수신</span></span>
<?php }?>
											</td>
										</tr>
										<tr><td colspan="2" height="1" bgcolor="#efefef" style="padding:0px;"></td></tr>
...
<?php if($GLOBALS["checked"]["useField"]["sms"]){?>
												<span class="noline" style="padding-left:10px"><input type="checkbox" name="sms" <?php echo $GLOBALS["checked"]["sms"]?>><span style="font-size:8pt;color:#007FC8" >문자서비스수신</span></span>
<?php }?>
											</td>
										</tr>
										<tr><td colspan="2" height="1" bgcolor="#efefef" style="padding:0px;"></td></tr>
