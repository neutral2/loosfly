...
<div style="width:170px;">
	<div align="center">SMS 상담 문의하기.</div>
	...
	<div style="border-style:solid; border-width: 0 1px; border-color:#D1D1D1; margin:0; padding:5px 0 15px; text-align:center;">
		<div><textarea name=msg onkeydown="ccsms.chkLen(this)" onkeyup="ccsms.chkLen(this)" onchange="ccsms.chkLen(this)" style="width:153px; height:132px; border:solid 1px #A0E3EC; background-color:#F6FCFC;"
			required msgR="메시지를 입력해주세요" style="font:9pt 굴림체;overflow:hidden;"></textarea>
		</div>
		...
		<div style="padding-right:10"><font color=444444>☎</font>  <input type=text name=callback size=15 required msgR="연락받을 번호를 입력해주세요" option="regNum" msgO="숫자만 입력해주세요" style="border:solid 1px #A0E3EC; background-color:#F6FCFC;"></div>

		<div style="padding-top:3" class="noline" id="avoidSubmit"><input type="image" src="/shop/data/skin/loosfly/img/common/sid_btn_sms.gif" alt="보내기"></div>
	</div>
	</form>
</div>
