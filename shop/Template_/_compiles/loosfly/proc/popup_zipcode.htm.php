<?php /* Template_ 2.2.7 2013/04/16 10:58:58 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/proc/popup_zipcode.htm 000003106 */ 
...
<tr>
	<td style="background:#000000; border-bottom:2px solid #DDDDDD"><img src="/shop/data/skin/loosfly/img/common/title_zipcode.gif"></td>
</tr>
<tr>
	...
	<TR>
		<TD class=input_txt>지역명 <input type=text name=dong value="<?php echo $GLOBALS["dong"]?>" required label="지역명" size=30><span class=noline><input type=image src="/shop/data/skin/loosfly/img/common/btn_search.gif" align=absmiddle></span></TD>
	</TR>
	</TABLE>
	</form>
