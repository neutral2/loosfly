<?php /* Template_ 2.2.7 2013/08/13 15:26:58 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/proc/popup_email.htm 000002879 */ ?>
<html>
<head>
<title>이메일보내기</title>
...
<tr>
	...
	<div style="width:100%; background:#000000; border-bottom:2px solid #DDDDDD"><img src="/shop/data/skin/loosfly/img/common/popup_title_email.gif"></div>
...
<?php }?>
	...
	<TABLE width=100%>
	<tr>
		<td align=center style="padding-top:5" class=noline><input type="image" src="/shop/data/skin/loosfly/img/common/btn_email.gif"></td>
	</tr>
	</TABLE>
	<TABLE width=100% cellpadding=0 cellspacing=0 border=0>
	<TR>
