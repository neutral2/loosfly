<?php /* Template_ 2.2.7 2014/01/15 14:46:16 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/proc/member_join_auth.htm 000010511 */ ?>
...
<!-- 상단이미지 || 현재위치 -->
		...
		<tr><td><img src="/shop/data/skin/loosfly/img/common/title_join.gif" border=0></td></tr>
		</TABLE>
...
<!-- 이용약관 -->
				<div><img src="/shop/data/skin/loosfly/img/common/join_txt_01.gif" border=0></div>
				<div style="background:#F1F1F1; text-align:center; padding:10px 10px 0 10px;">
					<textarea style="width:795px; height:250px; padding:10px; background:#FFFFFF" class=scroll readonly>
						<?php echo $this->define('tpl_include_file_1',"proc/_agreement.txt")?> <?php $this->print_("tpl_include_file_1",$TPL_SCP,1);?>
...
<!-- 개인정보취급방침 -->
				...
				<div style="padding-top:10px; background:#F1F1F1;text-align:center;">
					...
					<div id="boxScroll" class="scroll" style="width:795px; height:250px;">
...
<?php if($TPL_VAR["realnameyn"]=='y'){?>	
					<td class="noline">
						<label for="RnCheckType_jumin" style="width:130px;height:20px;display:inline-block;background:url('/shop/data/skin/loosfly/img/ipin/Regist_realName_title_1.gif') no-repeat 17px 3px;">
...
<?php if($TPL_VAR["ipinyn"]=='y'||$TPL_VAR["niceipinyn"]=='y'){?>
					<td class="noline">
						<label for="RnCheckType_ipin" style="width:150px;height:20px;display:inline-block;background:url('/shop/data/skin/loosfly/img/ipin/Regist_realName_title_2.gif') no-repeat 17px 3px;">
...
<?php if($TPL_VAR["hpauthDreamyn"]=='y'){?>
					<td class="noline">
						<label for="RnCheckType_hpauthDream" style="width:150px;height:20px;display:inline-block;background:url('/shop/data/skin/loosfly/img/auth/hpauth_title_3.gif') no-repeat 17px 3px;">
...
<!-- 하단버튼 -->
				<div align=center style="padding:50px 0 20px 0" class=noline>
					<a href="javascript:checkSubmit();"><img src="/shop/data/skin/loosfly/img/common/btn_join.gif"></a>
