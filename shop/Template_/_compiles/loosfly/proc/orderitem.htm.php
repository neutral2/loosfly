<?php /* Template_ 2.2.7 2013/12/17 11:27:29 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/proc/orderitem.htm 000007056 */ ?>
<style media="screen">
...
<?php if($GLOBALS["orderitem_mode"]=="cart"){?><th class="input_txt"><a href="javascript:void(0);" onClick="chkBox('idxs[]','rev');nsGodo_CartAction.recalc();">선택</a></th><?php }?>
	...
	<th class="input_txt" align="center">적립금</th>
	<th class="input_txt" align="center">판매가</th>
	<th class="input_txt" align="center">수량</th>
	<th class="input_txt" align="center">배송비</th>
	<th class="input_txt" align="center">합계</th>
</tr>
</thead>
<tbody>
...
<?php }?>
	...
	<div style="margin:5px 0 5px 0;overflow:hidden;height:1px;background:url(/shop/data/skin/loosfly/img/common/line2.gif) repeat-x top left;"></div>
...
<?php }?>
<?php if($GLOBALS["orderitem_mode"]=="cart"){?>
	<div style="margin:5px 0 5px 0"><a href="javascript:void(0);" onClick="nsGodo_CartAction.editOption('<?php echo $TPL_I1?>');"><img src="/shop/data/skin/loosfly/img/common/btn_check_modify.gif"></a></div>
<?php }?>
	</td>
...
<?php if($GLOBALS["orderitem_mode"]=="cart"){?>
		...
		<tr>
			...
			<td><div style="padding-bottom:2px"><img src="/shop/data/skin/loosfly/img/common/btn_plus.gif" onClick="chg_cart_ea(frmCart['ea[]'],'up',<?php echo $TPL_I1?>)" style="cursor:pointer"></div><img src="/shop/data/skin/loosfly/img/common/btn_minus.gif" onClick="chg_cart_ea(frmCart['ea[]'],'dn',<?php echo $TPL_I1?>)" style="cursor:pointer"></td>
			<td><input type=image src="/shop/data/skin/loosfly/img/common/sbtn_mod.gif"></td>
		</tr>
		</table>
<?php }else{?>
...
<tr>
	...
	<tr>
		<td align=right width="100" nowrap>상품합계금액</td>
