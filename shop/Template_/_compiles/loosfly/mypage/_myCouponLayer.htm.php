...
<div style="padding:10px 25px 0 30px;width:296px;background:url(/shop/data/skin/loosfly/img/common/bg_coupon_popup.gif) repeat-y top left;text-align:left;line-height:150%;font-size:12px;font-family:돋움; color:#464646; letter-spacing:-1; ">
