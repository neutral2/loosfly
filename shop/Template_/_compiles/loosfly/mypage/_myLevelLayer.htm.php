<?php /* Template_ 2.2.7 2013/04/16 10:58:56 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/mypage/_myLevelLayer.htm 000002262 */ ?>
<div id="MyLevelLayerBox" style="z-index:10000;position:absolute;width:187px;height:220px;display:block;text-align:center;">

<div><img src="/shop/data/skin/loosfly/img/common/h_member_level.gif"></div>
<div style="padding:0 25px 0 25px;width:296px;background:url(/shop/data/skin/loosfly/img/common/bg_member_level.gif) repeat-y top left;text-align:left;line-height:140%;font-size:11px;font-family:돋움; color:#464646; letter-spacing:-1">
...
<div><img src="/shop/data/skin/loosfly/img/common/foot_member_level.gif"></div>
<div style="width:296px;border-left:3px solid #DDDDDD;border-right:3px solid #DDDDDD;background:#ffffff;">
<a href="javascript:void(0);" onClick="document.getElementById('MyLevelLayerBox').style.display='none'"><img src="/shop/data/skin/loosfly/img/common/btn_member_level.gif"></a>
</div>
