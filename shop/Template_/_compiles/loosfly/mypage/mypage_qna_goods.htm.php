<?php /* Template_ 2.2.7 2013/12/16 18:59:11 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/mypage/mypage_qna_goods.htm 000005889 */ 
...
<?php }?>
	<div id="blkContents">
		...
		<!-- 상단이미지 -->
		<div id="bxBodyTitle">
			<img src="/shop/data/skin/loosfly/img/jimmy/titles/myproduct_inquiry_title_01.gif" border="0">			
		</div>
...
<?php if($TPL_V1["sno"]==$TPL_V1["parent"]){?>
		...
		<tr height=25 onmouseover=this.style.background="#F7F7F7" onmouseout=this.style.background="">
			...
			<TR>
				<TD style="padding-top:5"><span style="font-weight:bold;"><?php echo $TPL_V1["goodsnm"]?></span> <a href="<?php echo url("goods/goods_view.php?")?>&goodsno=<?php echo $TPL_V1["goodsno"]?>"><img src="/shop/data/skin/loosfly/img/common/btn_goodview2.gif" align=absmiddle></a></TD>
			</TR>
			<tr>
...
<?php }elseif($TPL_V1["sno"]!=$TPL_V1["parent"]){?>
		...
		<tr height=25 onmouseover=this.style.background="#F7F7F7" onmouseout=this.style.background="">
			<td width=50 align="center"><?php echo $TPL_V1["idx"]?></td>
			<td width=60 align="center"><img src="/shop/data/skin/loosfly/img/common/myqna_answer.gif"></td>
...
<?php if($TPL_V1["authreply"]=='Y'){?>
				<a href="javascript:;" onclick="popup_register( 'reply_qna', '<?php echo $TPL_V1["goodsno"]?>', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/loosfly/img/common/btn_reply.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_V1["authmodify"]=='Y'){?>
				<a href="javascript:;" onclick="popup_register( 'mod_qna', '<?php echo $TPL_V1["goodsno"]?>', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/loosfly/img/common/btn_modify2.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_V1["authdelete"]=='Y'){?>
				<a href="javascript:;" onclick="popup_register( 'del_qna', '<?php echo $TPL_V1["goodsno"]?>', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/loosfly/img/common/btn_delete.gif" border="0" align="absmiddle"></a>
<?php }?>
				</div>
			</div>
		</div>
