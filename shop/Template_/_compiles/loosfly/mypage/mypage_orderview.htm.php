<?php /* Template_ 2.2.7 2014/02/18 16:46:59 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/mypage/mypage_orderview.htm 000033109 */  $this->include_("displayEggBanner");
...
<?php if($TPL_V1["addopt"]){?><div>[<?php echo str_replace("^","] [",$TPL_V1["addopt"])?>]</div><?php }?></a>
					...
					<td align="center" class=stxt><FONT COLOR="#71cbd2"><?php echo $GLOBALS["r_istep"][$TPL_V1["istep"]]?></FONT></td>
					<td align="center">
<?php if($GLOBALS["set"]["delivery"]["basis"]&&$TPL_V1["dvcode"]){?>
					<a href="javascript:popup('mypage_delivery.php?item_sno=<?php echo $TPL_V1["sno"]?>',600,600)"><img src="/shop/data/skin/loosfly/img/common/btn_chase.gif"></a>
<?php }elseif(!$GLOBALS["set"]["delivery"]["basis"]&&$TPL_VAR["deliverycode"]){?>
					<a href="javascript:popup('mypage_delivery.php?ordno=<?php echo $TPL_VAR["ordno"]?>',600,600)"><img src="/shop/data/skin/loosfly/img/common/btn_chase.gif"></a>
<?php }?>
<?php if($TPL_V1["istep"]== 4){?><a href="javascript:;" onclick="popup_register( 'add_review', '<?php echo $TPL_V1["goodsno"]?>' )"><img src="/shop/data/skin/loosfly/img/common/btn_review.gif"></a><?php }?>
					</td>
				</tr>
...
<?php }}?>
				...
				<tr>
					...
					<td id="orderbox">
						<table>
						<col width="100">
						<tr><td>주문자명</td><td><?php echo $TPL_VAR["nameOrder"]?></td></tr>
						<tr><td>주문자 전화</td><td><?php echo $TPL_VAR["phoneOrder"]?></td></tr>
						<tr><td>주문자 핸드폰</td><td><?php echo $TPL_VAR["mobileOrder"]?></td></tr>
						<tr><td>이메일</td><td><?php echo $TPL_VAR["email"]?></td></tr>
						</table>
					</td>
				</tr>
				</table>
...
<?php }?>
				...
				<tr>
					...
					<td id="orderbox">
						<table>
						<col width="100">
						<tr><td>받는자명</td><td><?php echo $TPL_VAR["nameReceiver"]?></td></tr>
						<tr><td>받는자 전화</td><td><?php echo $TPL_VAR["phoneReceiver"]?></td></tr>
						<tr><td>받는자 핸드폰</td><td><?php echo $TPL_VAR["mobileReceiver"]?></td></tr>
						<tr><td>우편번호</td><td><?php echo $TPL_VAR["zipcode"]?></td></tr>
						<tr><td>주소</td><td><?php echo $TPL_VAR["address"]?> <?php echo $TPL_VAR["address_sub"]?><div style="padding-top:5px;font:12px dotum;color:#999;"><?php echo $TPL_VAR["road_address"]?> <?php echo $TPL_VAR["address_sub"]?></div></td></tr>
<?php if($TPL_VAR["memo"]){?>
						<tr><td>배송메세지</td><td><?php echo $TPL_VAR["memo"]?></td></tr>
<?php }?>
<?php if($TPL_VAR["deliverycode"]){?>
						<tr><td>송장번호</td><td><?php echo $TPL_VAR["deliverycomp"]?> <?php echo $TPL_VAR["deliverycode"]?></td></tr>
<?php }?>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td id="orderbox">
						...
						<col width="100">
						<col align="right">
						<tr><td>총주문금액</td><td><span id="paper_goodsprice"><?php echo number_format($TPL_VAR["goodsprice"])?></span>원</td></tr>
						<tr>
							<td>배송비</td>
							<td>
...
<?php if($TPL_VAR["item"][ 0]['todaygoods']!='y'){?>
						<tr><td>회원할인</td><td>- <span id="paper_memberdc"><?php echo number_format($TPL_VAR["memberdc"])?></span>원</td></tr>
						<tr><td>쿠폰할인</td><td>- <span id="paper_coupon"><?php echo number_format($TPL_VAR["coupon"])?></span>원</td></tr>
						<tr><td>적립금 사용</td><td>- <span id="paper_emoney"><?php echo number_format($GLOBALS["data"]["emoney"])?></span>원</td></tr>
<?php if($GLOBALS["data"]["ncash_emoney"]){?>
						<tr><td>네이버마일리지</td><td>- <span id="paper_emoney"><?php echo number_format($GLOBALS["data"]["ncash_emoney"])?></span>원</td></tr>
<?php }?>
<?php if($GLOBALS["data"]["ncash_cash"]){?>
						<tr><td>네이버캐쉬</td><td>- <span id="paper_emoney"><?php echo number_format($GLOBALS["data"]["ncash_cash"])?></span>원</td></tr>
<?php }?>
<?php }?>
<?php if($TPL_VAR["eggFee"]){?>
						<tr><td>보증보험 수수료</td><td><span id="paper_eggfee"><?php echo number_format($TPL_VAR["eggFee"])?></span>원</td></tr>
<?php }?>
						<tr><td>결제금액</td><td><b><span id="paper_settlement"><?php echo number_format($TPL_VAR["settleprice"])?></span>원</b></td></tr>
...
<?php if($TPL_VAR["settlekind"]=="a"){?>
						<tr><td>입금은행</td><td><?php echo $TPL_VAR["bank"]?></td></tr>
						<tr><td>입금계좌</td><td><?php echo $TPL_VAR["account"]?></td></tr>
						<tr><td>예금주명</td><td><?php echo $TPL_VAR["name"]?></td></tr>
						<tr><td>입금자명</td><td><?php echo $TPL_VAR["bankSender"]?></td></tr>
...
<?php }elseif($TPL_VAR["settlekind"]=="v"){?>
						<tr><td>가상계좌</td><td><?php echo $TPL_VAR["vAccount"]?></td></tr>
...
<?php if($TPL_VAR["memberdc"]){?>
						<tr><td>회원할인</td><td id="memberdc"><?php echo number_format($TPL_VAR["memberdc"])?>원</td></tr>
<?php }?>
<?php if($TPL_VAR["coupon"]){?>
						<tr><td>쿠폰할인</td><td><?php echo number_format($TPL_VAR["coupon"])?>원</td></tr>
<?php }?>
						<tr><td>적립금결제</td><td><b><?php echo number_format($TPL_VAR["emoney"])?>원</b></td></tr>
<?php }?>
<?php if($TPL_VAR["step"]== 0&&$TPL_VAR["step2"]== 54&&in_array($TPL_VAR["settlekind"],array('c','o','v'))&&$TPL_VAR["pgfailreason"]){?><!-- 결제실패사유 -->
						<tr><td>결제실패사유</td><td><?php echo $TPL_VAR["pgfailreason"]?></td></tr>
<?php }?>
<?php if($TPL_VAR["eggyn"]=='y'){?>
						<tr><td>전자보증보험</td><td><a href="javascript:popupEgg('<?php echo $GLOBALS["egg"]["usafeid"]?>', '<?php echo $TPL_VAR["ordno"]?>')"><font color=#0074BA><b><u><?php echo $TPL_VAR["eggno"]?> <font class=small>(보증서출력)</a></td></tr>
...
<?php if($GLOBALS["ableCashbag"]){?><!-- OK캐쉬백 -->
				...
				<tr>
					...
					<td id="orderbox">
					<div><a href="javascript:okcashbag();"><img src="/shop/data/skin/loosfly/img/common/btn_okcash.gif"></a></div>
...
<?php if($TPL_VAR["cbyn"]=='Y'&&$TPL_VAR["step"]=='4'&&$TPL_VAR["oktno"]){?><!-- OK캐쉬백 적립 정보-->
				...
				<tr>
					...
					<td id="orderbox">
						...
						<table>
						<col width="100">
						<tr><td>거래번호</td><td><?php echo $TPL_VAR["oktno"]?></td></tr>
						<tr><td>적립포인트</td><td><?php echo number_format($TPL_VAR["add_pnt"])?></td></tr>
						</table>
					</td>
				</tr>
				</table><div style="font-size:0;height:5px"></div>
...
<?php if($GLOBALS["sess"]){?>
				<div align="right" class="stxt" style="padding:5px 0"><font size="2" COLOR="#007FC8">※</font> <FONT COLOR="#71cbd2">주문취소/교환/반품을 원하시면 마이페이지의 <A HREF="<?php echo url("mypage/mypage_qna.php")?>&"><U>1:1문의게시판</U></A>을 이용하세요</font></div>
<?php }?>
				
				<div style="padding:20px" align="center" id="avoidDblPay">
				<a href="javascript:history.back();"><img src="/shop/data/skin/loosfly/img/common/btn_back.gif" border="0"></a>
<?php if($TPL_VAR["step"]== 0&&$TPL_VAR["step2"]== 0){?><a href="javascript:chkCancel();"><img src="/shop/data/skin/loosfly/img/common/btn_order_cancel.gif" border=0></a><?php }?>
<?php if($GLOBALS["resettleAble"]){?><a href="javascript:chkReSettle();"><img src="/shop/data/skin/loosfly/img/common/btn_again_order.gif" border=0></a></div><?php }?>
				<div style="font-size:0;height:5px"></div>
			</div><!-- End indiv -->
		</div>
