<?php /* Template_ 2.2.7 2013/12/19 16:19:18 /www/loosfly_godo_co_kr/shop/data/skin/loosfly/order/nscreen_settle.htm 000014046 */ 
...
<tr><td><img src="/shop/data/skin/loosfly/img/common/title_payment.gif" border=0></td></tr>
...
<img src="/shop/data/skin/loosfly/img/common/payment_txt_01.gif" border=0>
<!-- 01 주문자정보 -->
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/loosfly/img/common/order_step_01.gif"></td>
	<td id="orderbox">
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/loosfly/img/common/order_step_02.gif"></td>
	<td id="orderbox">
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/loosfly/img/common/order_step_03.gif"></td>
	<td id="orderbox">
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/loosfly/img/common/order_step_04.gif"></td>
	<td id="orderbox">
...
<a href="javascript:submitSettleForm()"><img src="/shop/data/skin/loosfly/img/common/btn_payment.gif"></a>
<a href="<?php echo url("order/order.php")?>&"><img src="/shop/data/skin/loosfly/img/common/btn_back.gif"></a>
</div>
...
function swapSettleButton(){
	if (document.getElementById('avoidDblPay')) document.getElementById('avoidDblPay').innerHTML = "<a href='javascript:submitSettleForm()'><img src='/shop/data/skin/loosfly/img/common/btn_payment.gif'></a><a href='<?php echo url("order/order.php")?>&'><img src='/shop/data/skin/loosfly/img/common/btn_back.gif'></a>";
}
...
<?php }?>
	...
	if (document.getElementById('avoidDblPay')) document.getElementById('avoidDblPay').innerHTML = "--- 현재 결제처리중입니다. 잠시만 기다려주세요. ---<br><a href='javascript:swapSettleButton();'><img src='/shop/data/skin/loosfly/img/common/btn_cancel.gif'></a>";
