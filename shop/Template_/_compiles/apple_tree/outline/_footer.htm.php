...
<?php }else{?>
<div><!-- 맨오른쪽_스크롤배너 (배너관리에서 수정가능) --><?php if(is_array($TPL_R1=dataBanner( 17))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></div>
<?php }?>
...
<div style="margin-bottom:5px;">
	...
	<tr>
		<td><!-- 맨오른쪽_스크롤배너_top (배너관리에서 수정가능) --><?php if(is_array($TPL_R1=dataBanner( 28))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></td>
		<td><!-- 맨오른쪽_스크롤배너_back (배너관리에서 수정가능) --><?php if(is_array($TPL_R1=dataBanner( 29))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></td>
	</tr>
	</table>
</div>

<div><!-- 맨오른쪽_스크롤배너 (배너관리에서 수정가능) --><?php if(is_array($TPL_R1=dataBanner( 18))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></div>
</div>
