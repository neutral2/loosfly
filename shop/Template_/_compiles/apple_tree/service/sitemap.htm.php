...
<TR>
	...
	<tr>
		...
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle>회원관련</TD>
		</tr>
		<tr>
			<td class=s_cate>
		...
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle>나의글모음</TD>
		</tr>
		<tr>
			<td class=s_cate>
	...
	<tr>
		...
		<TABLE width=195 cellpadding=3 cellspacing=0 border=0>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("goods/goods_cart.php")?>&">장바구니</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("mypage/mypage_orderlist.php")?>&">주문/배송조회</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("goods/goods_search.php")?>&">상세검색</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("mypage/mypage_today.php")?>&">최근본상품</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("mypage/mypage_emoney.php")?>&">적립금</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("mypage/mypage_wishlist.php")?>&">상품보관함</A></TD>
		</tr>
		</TABLE>
		<br>
		</td>
...
<?php }?>
	...
	<tr>
		...
		<TABLE width=195 cellpadding=3 cellspacing=0 border=0>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("service/customer.php")?>&">고객센터</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("mypage/mypage_qna.php")?>&">1:1문의</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("member/myinfo.php")?>&">마이페이지</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("service/company.php")?>&">회사소개</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("service/private.php")?>&">개인정보보호정책</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("service/faq.php")?>&">자주하는질문</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("service/cooperation.php")?>&">광고/제휴문의</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("service/guide.php")?>&">이용안내</A></TD>
		</tr>
		<tr>
			<TD class="bb_cate"><img src="/shop/data/skin/apple_tree/img/common/sitemap_icon.gif" align=absmiddle><A HREF="<?php echo url("service/sitemap.php")?>&">사이트맵</A></TD>
		</tr>
		</TABLE>
		<br>
		</td>
