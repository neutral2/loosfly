<?php /* Template_ 2.2.7 2012/11/14 17:43:56 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/service/faq.htm 000004505 */ 
...
<tr>
	<td><img src="/shop/data/skin/apple_tree/img/common/title_faq.gif" border=0></td>
</tr>
<TR>
...
<tr>
	...
	<tr>
		<td height=40 style="padding-left:10"><img src="/shop/data/skin/apple_tree/img/common/faq_01.gif" align=absmiddle><input type="text" NAME="sword" value="<?php echo $_GET['sword']?>" size=32></td>
		<td class=noline><input type="image" src="/shop/data/skin/apple_tree/img/common/btn_search.gif"></td>
	</tr>
	</table>
	<TABLE width=100% cellpadding="5" cellspacing="0" border="0">
	<TR>
		<TD bgcolor="#F3F3F3" class=input_txt height=40 style="padding-top:10; padding-left:10">
<?php if(is_array($TPL_R1=codeitem('faq'))&&!empty($TPL_R1)){$TPL_S1=count($TPL_R1);$TPL_I1=-1;foreach($TPL_R1 as $TPL_K1=>$TPL_V1){$TPL_I1++;?>
...
<?php if($TPL_V1["descant"]!=''){?>
	...
	<tr valign="top">
		<th style="color:#bf0000;width:40; padding-top:1"><img src="/shop/data/skin/apple_tree/img/common/faq_q.gif"></th>
...
<?php }?>
	<table cellpadding=0 cellspacing=0 border=0>
	<tr valign="top">
		<th style="color:#0000bf;width:40; padding-top:1"><img src="/shop/data/skin/apple_tree/img/common/faq_a.gif"></th>
