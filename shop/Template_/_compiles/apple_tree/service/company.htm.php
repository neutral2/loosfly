...
<tr>
<td><!-- 회사소개 로고 (배너관리에서 수정가능) --><?php if(is_array($TPL_R1=dataBanner( 23))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></td>
...
<tr>
<td align=middle colspan=2><!-- 회사약도 (배너관리에서 수정가능) --><?php if(is_array($TPL_R1=dataBanner( 22))&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></td>
</tr>
</table>
