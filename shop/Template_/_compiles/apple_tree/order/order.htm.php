<?php /* Template_ 2.2.7 2013/03/19 14:44:17 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/order/order.htm 000035968 */  $this->include_("displayEggBanner");
...
<tr>
	<td><img src="/shop/data/skin/apple_tree/img/common/title_order_01.gif" border=0></td>
</tr>
<TR>
...
<div><img src="/shop/data/skin/apple_tree/img/common/order_txt_01.gif" border=0></div>
...
<!-- 비회원 개인정보 취급방침 내용 -->
<div style="margin-top:20;"><img src="/shop/data/skin/apple_tree/img/common/order_txt_non.gif" border=0></div>
...
<div style="margin-top:20;"><img src="/shop/data/skin/apple_tree/img/common/order_txt_02.gif" border=0></div>
...
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/apple_tree/img/common/order_step_01.gif"></td>
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/apple_tree/img/common/order_step_02.gif"></td>
	<td style="padding:10px">
	...
	<tr>
		<td>받으실곳</td>
		<td>
		<input type=text name=zipcode[] size=3 class=line readonly value="<?php echo $TPL_VAR["zipcode"][ 0]?>" required> -
		<input type=text name=zipcode[] size=3 class=line readonly value="<?php echo $TPL_VAR["zipcode"][ 1]?>" required>
		<a href="javascript:popup_zipcode('opener.document.frmOrder')"><img src="/shop/data/skin/apple_tree/img/common/btn_zipcode.gif" align=absmiddle></a>
		</td>
	</tr>
	<tr>
		<td></td>
		<td><input type=text name=address class=lineBig readonly value="<?php echo $TPL_VAR["address"]?>" required></td>
	</tr>
	<tr>
		<td></td>
		<td><input type=text name=address_sub class=lineBig value="<?php echo $TPL_VAR["address_sub"]?>" required label="세부주소"></td>
	</tr>
	<tr>
		<td>전화번호</td>
		<td>
		<input type=text name=phoneReceiver[] value="<?php echo $TPL_VAR["phone"][ 0]?>" size=3 maxlength=3 required> -
		<input type=text name=phoneReceiver[] value="<?php echo $TPL_VAR["phone"][ 1]?>" size=4 maxlength=4 required> -
		<input type=text name=phoneReceiver[] value="<?php echo $TPL_VAR["phone"][ 2]?>" size=4 maxlength=4 required>
		</td>
	</tr>
	<tr>
		<td>핸드폰번호</td>
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/apple_tree/img/common/order_step_03.gif"></td>
	<td style="padding:10px">
...
<?php if($GLOBALS["sess"]){?>
	...
	<tr>
		...
		<tr>
			...
			<a href="javascript:popup('../proc/popup_coupon.php',600,700)"><img src="/shop/data/skin/apple_tree/img/common/btn_coupon.gif" align=absmiddle hspace=2></a><span id="del_coupon" style="visibility:hidden"><a href='javascript:del_coupon();'><img src="/shop/data/skin/apple_tree/img/common/btn_coupon_del.gif" align=absmiddle hspace=2></a></span>
			</td>
		</tr>
		<tr>
...
<?php if($GLOBALS["sess"]&&$TPL_VAR["ncash"]["save_mode"]=='choice'){?>
			...
			<input type="radio" name="save_mode" value="ncash"> 네이버 마일리지<br/>
<?php }elseif($GLOBALS["sess"]&&$TPL_VAR["ncash"]["save_mode"]=='both'){?>
			...
			<input type="radio" name="save_mode" value="both" checked> 쇼핑몰 적립금 과 네이버 마일리지 동시 적립<br/>
<?php }else{?>
			<input type="radio" name="save_mode" value="unused" onclick="naver_mileage_initialize(this);"> 네이버 마일리지 사용/적립 안함<br/>
			<input type="radio" name="save_mode" value="ncash"> 네이버 마일리지<br/>
<?php }?>
			<div id="save_button"><img src="/shop/data/skin/apple_tree/img/nmileage/n_mileage_use.gif" onClick="javascript:cash_save_use();" class="mileage_button"> 버튼을 클릭해서 <span style="color: #1ec228; font-weight: bold;"><?php echo $TPL_VAR["ncash"]["N_ba"]+$TPL_VAR["ncash"]["N_aa"]?>%</span> 적립받고 사용하세요 <img class="n_mileage" src="/shop/data/skin/apple_tree/img/nmileage/n_mileage_info2.gif" onclick="mileage_info();"></div>
...
<?php }?>
	...
	<tr>
		<td>총 결제금액</td>
		<td><span id=paper_settlement style="width:146px;text-align:right;font:bold 14px tahoma; color:FF6C68;"><?php echo number_format($TPL_VAR["cart"]->totalprice-$TPL_VAR["cart"]->dcprice)?></span> 원</td>
	</tr>
	</table>
	</td>
</tr>
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/apple_tree/img/common/order_step_04.gif"></td>
	<td style="padding:10px">
...
<input type="image" src="/shop/data/skin/apple_tree/img/common/btn_payment.gif">
<img src="/shop/data/skin/apple_tree/img/common/btn_cancel.gif" onclick="history.back()" style="cursor:pointer">
</div>
...
<?php if($TPL_VAR["ncash"]["useyn"]=='Y'){?>
	settlement = settlement - document.getElementById('totalUseAmount<?php echo $TPL_VAR["ncash"]["api_id"]?>').value;
<?php }?>
...
function cash_save_use(){
	var
	goodsprice = uncomma(document.getElementById('paper_goodsprice')[document.getElementById('paper_goodsprice').innerText?"innerText":"textContent"]),
	delivery_price = uncomma(document.getElementById('paper_delivery')[document.getElementById('paper_delivery').innerText?"innerText":"textContent"]),
