<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/goods_list.htm 000010153 */  $this->include_("dataSubCategory","dataDisplayGoods");?>
...
<tr>
<td background="/shop/data/skin/apple_tree/img/common/ed_top_back.gif">
<table width=100% border=0 cellpadding=0 cellspacing=0>
<tr><td width=50%><img src="/shop/data/skin/apple_tree/img/common/ed_left_top.gif" border=0></td>
<td width=50% align=right><img src="/shop/data/skin/apple_tree/img/common/ed_right_top.gif" border=0></td>
</tr></table>
</td>
</tr>
<tr>
<td bgcolor="#F5F5F5" style="padding:5px 10px; border-left:1px solid #E2E1E1; border-right:1px solid #E2E1E1"><img src="/shop/data/skin/apple_tree/img/common/icon_submenu.gif" border=0 align=absmiddle><b><?php echo currPosition($GLOBALS["category"])?></b></td>
</tr>
<tr>
...
<tr>
<td background="/shop/data/skin/apple_tree/img/common/ed_bot_back.gif">
<table width=100% border=0 cellpadding=0 cellspacing=0>
<tr><td width=50%><img src="/shop/data/skin/apple_tree/img/common/ed_left_bot.gif" border=0></td>
<td width=50% align=right><img src="/shop/data/skin/apple_tree/img/common/ed_right_bot.gif" border=0></td>
</tr></table>
</td>
</tr>
</table>
...
<tr>
<td bgcolor=9e9e9e class=small height=27 style="padding:0 0 0 5" background="/shop/data/skin/apple_tree/img/common/bg_goodlist_bar.gif">
<table width=100% border=0 cellpadding=0 cellspacing=0>
<tr>
<td id="b_white"><img src="/shop/data/skin/apple_tree/img/common/icon_goodalign2.gif" align=absmiddle><?php echo currPosition($GLOBALS["category"])?>
...
<td align=right><img src="/shop/data/skin/apple_tree/img/common/goodlist_txt_06.gif" align=absmiddle><select onchange="if(typeof(document.sSearch) != 'undefined') { _ID('page_num').value=this.value; document.sSearch.submit() } else { this.form.page_num.value=this.value;this.form.submit() }" style="font:8pt 돋움"><?php if(is_array($TPL_R1=$TPL_VAR["lstcfg"]["page_num"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><option value="<?php echo $TPL_V1?>" <?php echo $GLOBALS["selected"]["page_num"][$TPL_V1]?>><?php echo $TPL_V1?>개씩 정렬<?php }}?></select></td>
</tr>
</table>
...
if(typeof(document.sSearch) != "undefind") fm = document.sSearch;
fm.sort.value = sort;
fm.submit();
}
