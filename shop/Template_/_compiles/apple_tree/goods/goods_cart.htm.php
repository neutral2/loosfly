<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/goods_cart.htm 000004899 */ ?>
...
<tr>
<td><img src="/shop/data/skin/apple_tree/img/common/title_cart.gif" border=0></td>
</tr>
<TR>
...
<a href="<?php echo url("goods/goods_cart.php")?>&"><img src="/shop/data/skin/apple_tree/img/common/btn_basket_shopping.gif"></a>
<a href="<?php echo url("goods/goods_cart.php?")?>&cart_type=todayshop"><img src="/shop/data/skin/apple_tree/img/common/btn_basket_today.gif"></a>
<?php }?>
...
<?php if(count($TPL_VAR["cart"]->item)){?>
	<a href="javascript:void(0);" onClick="nsGodo_CartAction.del();return false;" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/btn_check_delete.gif" border=0></a>&nbsp;
	<a href="javascript:void(0);" onClick="nsGodo_CartAction.order();return false;" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/btn_check_order.gif" border=0></a>&nbsp;
	<a href="javascript:void(0);" onClick="nsGodo_CartAction.wishList();return false;" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/btn_check_wslist.gif" border=0></a>&nbsp;
<?php }?>
<a href="javascript:history.back();"onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/btn_back2.gif" border=0></a>&nbsp;
<a href="<?php echo url("goods/goods_cart.php?")?>&mode=empty" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/btn_empty2.gif" border=0></a>&nbsp;
<a href="<?php echo url("index.php")?>&" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/btn_continue2.gif" border=0></a></td>
</tr>
</TABLE>
