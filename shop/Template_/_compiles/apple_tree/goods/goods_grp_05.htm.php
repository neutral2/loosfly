<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/goods_grp_05.htm 000006925 */ 
...
<tr>
<td><img src="/shop/data/skin/apple_tree/img/common/title_specialitems.gif" border=0></td>
</tr>
<TR>
<td class="path">HOME > <B>스페셜상품</B></td>
</TR>
</TABLE>
<!-- 타이틀이미지 네임 :::
할인상품 <img src="/shop/data/skin/apple_tree/img/common/title_discount.gif" border=0>
베스트상품 <img src="/shop/data/skin/apple_tree/img/common/title_best.gif" border=0>
추천상품 <img src="/shop/data/skin/apple_tree/img/common/title_recomgoods.gif" border=0>
스페셜상품 <img src="/shop/data/skin/apple_tree/img/common/title_specialitems.gif" border=0>
-->
...
<td align=right><img src="/shop/data/skin/apple_tree/img/common/goodlist_txt_06.gif" align=absmiddle><select onchange="this.form.page_num.value=this.value;this.form.submit()" style="font:8pt 돋움"><?php if($TPL__r_page_num_1){foreach($GLOBALS["r_page_num"] as $TPL_V1){?><option value="<?php echo $TPL_V1?>" <?php echo $GLOBALS["selected"]["page_num"][$TPL_V1]?>><?php echo $TPL_V1?>개씩 정렬<?php }}?></select></td>
</tr>
</table>
