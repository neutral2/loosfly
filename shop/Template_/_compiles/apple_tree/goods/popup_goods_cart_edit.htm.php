<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/popup_goods_cart_edit.htm 000017269 */ 
...
<img src="/shop/data/skin/apple_tree/img/common/cart_option_edit_title.gif">


<form name="frmCartOption" method="post" action="<?php echo url("goods/goods_cart.php?")?>&cart_type=<?php echo $_GET["cart_type"]?>" onsubmit="return chkForm(this);">
...
<div style="margin:15px 0 15px 0;overflow:hidden;height:1px;background:url(/shop/data/skin/apple_tree/img/common/line2.gif) repeat-x top left;"></div>


<!-- 필수 옵션 일체형 -->
<?php if($GLOBALS["opt"]&&$GLOBALS["typeOption"]=="single"){?>
<div style="margin-bottom:10px;">
<span style="display:block;margin-bottom:5px;font-weight:bold;color:#565656;"><img src="/shop/data/skin/apple_tree/img/common/btn_multioption_br.gif" align="absmiddle"> 옵션명 (<?php echo $TPL_VAR["optnm"]?>)</span>
...
<?php if($TPL__optnm_1){$TPL_I1=-1;foreach($GLOBALS["optnm"] as $TPL_V1){$TPL_I1++;?>
	<div style="margin-bottom:10px;">
	<span style="display:block;margin-bottom:5px;font-weight:bold;color:#565656;"><img src="/shop/data/skin/apple_tree/img/common/btn_multioption_br.gif" align="absmiddle"> 옵션명 <?php echo $TPL_I1+ 1?> (<?php echo $TPL_V1?>)</span>
...
<?php if(!$TPL_I1){?>
	...
	<option value="">== 옵션선택 ==
<?php if(is_array($TPL_R2=($GLOBALS["opt"]))&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_K2=>$TPL_V2){?><option value="<?php echo $TPL_K2?>" <?php if($TPL_K2==$TPL_VAR["item"]["opt"][ 0]){?>selected<?php }?>><?php echo $TPL_K2?><?php }}?>
	</select>
	</div>
<?php }else{?>
...
<div style="margin-bottom:10px;">
<span style="display:block;margin-bottom:5px;font-weight:bold;color:#565656;"><img src="/shop/data/skin/apple_tree/img/common/btn_multioption_br.gif" align="absmiddle"> <?php echo $TPL_K1?></span>
...
<div style="margin:15px 0 5px 0;overflow:hidden;height:1px;background:url(/shop/data/skin/apple_tree/img/common/line.gif) repeat-x top left;"></div>

<!-- 수량 -->
<div style="float:left;font-weight:bold;color:#565656;padding-top:6px;"><img src="/shop/data/skin/apple_tree/img/common/btn_multioption_br.gif" align="absmiddle"> 수량</div>

<div style="float:left;margin-left:5px;"><input type=text name=ea  size=2 value='<?php echo $TPL_VAR["item"]["ea"]?>' style="border:1px solid #D3D3D3;width:30px;text-align:right;height:20px"></div>
<div style="float:left;padding-left:3">
<div style="padding:1 0 2 0"><img src="/shop/data/skin/apple_tree/img/common/btn_multioption_ea_up.gif" onClick="chg_cart_ea(frmCartOption.ea,'up')" style="cursor:pointer"></div>
<div><img src="/shop/data/skin/apple_tree/img/common/btn_multioption_ea_down.gif" onClick="chg_cart_ea(frmCartOption.ea,'dn')" style="cursor:pointer"></div>
</div>

</div>

<div style="text-align:center;padding:10px;">
	<input type="image" src="/shop/data/skin/apple_tree/img/common/btn_modify.gif">
	<a href="javascript:void(0);" onClick="self.close();"><img src="/shop/data/skin/apple_tree/img/common/btn_cancel3.gif"></a>
</div>
