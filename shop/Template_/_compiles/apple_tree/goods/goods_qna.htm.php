<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/goods_qna.htm 000006916 */ 
...
<tr>
	<td><img src="/shop/data/skin/apple_tree/img/common/title_qna.gif" border=0></td>
</tr>
<TR>
...
<?php if($TPL_V1["type"]=='Q'){?>
	<td style="padding-left:0px;cursor:pointer;" onclick="view_content('<?php echo $TPL_V1["sno"]?>')"><div style="background-image: url(/shop/data/skin/apple_tree/img/common/ico_q.gif); background-repeat:no-repeat;background-position:left 3px;padding:3px 0px 0px 20px;"><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["secretIcon"]){?>&nbsp;<img src="/shop/data/skin/apple_tree/img/common/icn_secret.gif" align=absmiddle><?php }?></div></td>
...
<?php }elseif($TPL_V1["type"]=='N'){?>
	<td style="padding-left:5px;cursor:pointer;" onclick="view_content('<?php echo $TPL_V1["sno"]?>')"><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["secretIcon"]){?>&nbsp;<img src="/shop/data/skin/apple_tree/img/common/icn_secret.gif" align=absmiddle><?php }?></div></td>
<?php }?>
...
<a href="javascript:;" onclick="popup_register( 'add_qna', '' )"><img src="/shop/data/skin/apple_tree/img/common/btn_qna.gif"></a>
</div>
