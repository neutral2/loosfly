<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/goods_search.htm 000013510 */ ?>
...
<tr>
<td><img src="/shop/data/skin/apple_tree/img/common/title_search.gif" border=0></td>
</tr>
<TR>
...
<td style="text-align:center;padding-top:20px;">
	...
	<span class=noline><input type="image" src="/shop/data/skin/apple_tree/img/common/btn_search.gif" align=absmiddle></span>
...
<?php }}?>
	...
	<td style="text-align:right">
		<span class=noline><input type="image" src="/shop/data/skin/apple_tree/img/common/btn_search_b.gif" align=absmiddle></span>
	</td>
	</tr>
	</table>
</td>
...
<?php if($_GET['disp_type']=='list'){?>
	<img name="disp_list" src="/shop/data/skin/apple_tree/img/common/btn_list_on.gif">
<?php }else{?>
	<img name="disp_list" src="/shop/data/skin/apple_tree/img/common/btn_list_off.gif">
<?php }?>
</a>
<a href="javascript: add_param_submit('disp_type', 'gallery')">
<?php if($_GET['disp_type']=='gallery'){?>
	<img name="disp_gallery" src="/shop/data/skin/apple_tree/img/common/btn_gallery_on.gif">
<?php }else{?>
	<img name="disp_gallery" src="/shop/data/skin/apple_tree/img/common/btn_gallery_off.gif">
<?php }?>
</a>
<?php }?>
</td>
