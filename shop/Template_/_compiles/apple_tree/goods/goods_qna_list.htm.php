<?php /* Template_ 2.2.7 2012/12/21 14:22:18 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/goods_qna_list.htm 000004957 */ 
...
<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/apple_tree/img/common/bar_detail_04.gif) no-repeat;" nowrap width="100" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/apple_tree/img/common/bar_detail_04_bg.gif) repeat-x;" width='90%'></TD>
		<TD style="background: URL(/shop/data/skin/apple_tree/img/common/bar_detail_04_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
</table>
...
<a href="<?php echo url("goods/goods_qna.php")?>&" target="_parent"><img src="/shop/data/skin/apple_tree/img/common/info_btn_totalview.gif"></a>
<a href="javascript:;" onclick="popup_register( 'add_qna', '<?php echo $GLOBALS["goodsno"]?>' )"><img src="/shop/data/skin/apple_tree/img/common/btn_qna.gif"></a>
</div>
