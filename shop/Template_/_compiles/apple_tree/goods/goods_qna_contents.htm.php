<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/goods/goods_qna_contents.htm 000002008 */ ?>
...
<?php if($TPL_VAR["parent"]==$TPL_VAR["sno"]&&!$TPL_VAR["notice"]){?>
	<a href="javascript:;" onclick="popup_register( 'reply_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/apple_tree/img/common/btn_reply.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_VAR["authmodify"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'mod_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/apple_tree/img/common/btn_modify2.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_VAR["authdelete"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'del_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/apple_tree/img/common/btn_delete.gif" border="0" align="absmiddle"></a>
<?php }?>
	</div>
	</td>
</tr>
