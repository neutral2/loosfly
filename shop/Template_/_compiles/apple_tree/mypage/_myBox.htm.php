<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/mypage/_myBox.htm 000005137 */ ?>
...
<br/>
&nbsp;&nbsp;&nbsp;<a href="javascript: member_grp_pop();"><img src="/shop/data/skin/apple_tree/img/common/btn_benefit.gif"></a>
<?php }?>
</td>
<td>
...
<div><img src="/shop/data/skin/apple_tree/img/common/benefit_01.gif"></div>
<div style="padding:0 25px 0 30px;width:374px;background:url(/shop/data/skin/apple_tree/img/common/benefit_02.gif) repeat-y top left;text-align:left;line-height:150%;font-size:12px;font-family:돋움; color:#464646; letter-spacing:-1; ">
	<div>
...
<div style="background: url('/shop/data/skin/apple_tree/img/common/benefit_03.gif'); width:374px; height:75px;">
	<div style="padding-top:25px;"></div>
	<a href="javascript:void(0);" onClick="document.getElementById('MyMemberGrpBpx').style.display='none'"><img src="/shop/data/skin/apple_tree/img/common/btn_benefit_check.gif"></a>
</div>
