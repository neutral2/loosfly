<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/mypage/mypage_orderlist.htm 000002768 */ 
...
<tr>
	<td><img src="/shop/data/skin/apple_tree/img/common/title_orderlist.gif" border=0></td>
</tr>
<TR>
...
<?php if($TPL_V1["step"]== 3&&!$TPL_V1["step2"]){?>
	<a href="javascript:order_confirm(<?php echo $TPL_V1["ordno"]?>)"><img src="/shop/data/skin/apple_tree/img/common/btn_receive.gif"></a>
<?php }elseif($TPL_V1["escrowconfirm"]== 2){?>수령
<?php }?>
	</td>
	<td align=center><a href="<?php echo url("mypage/mypage_orderview.php?")?>&ordno=<?php echo $TPL_V1["ordno"]?>"><img src="/shop/data/skin/apple_tree/img/common/btn_detailview.gif"></a></td>
</tr>
