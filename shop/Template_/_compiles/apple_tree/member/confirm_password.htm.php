<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/member/confirm_password.htm 000001991 */ ?>
...
<div id="cp_body">
	...
	<div id="cp_title"><img src="/shop/data/skin/apple_tree/img/common/h_pass_rember.gif" /></div>
	...
	<div id="cp_button">
		<input type="image" src="/shop/data/skin/apple_tree/img/common/btn_gr_enter.gif" />
		<a href="javascript:;" onclick="history.go(-1);"><img src="/shop/data/skin/apple_tree/img/common/btn_gr_cancle.gif" border="0" /></a>
	</div>
	</form>
</div>