<?php /* Template_ 2.2.7 2012/11/14 15:07:40 /www/loosfly_godo_co_kr/shop/data/skin/apple_tree/member/login.htm 000003978 */ ?>
...
<tr>
	<td><img src="/shop/data/skin/apple_tree/img/common/title_login.gif" border=0></td>
</tr>
<TR>
...
<div style="padding-top:10; padding-bottom:30; text-align:center"><img src="/shop/data/skin/apple_tree/img/common/login_01.gif"></div>

<div><img src="/shop/data/skin/apple_tree/img/common/login_02.gif" border=0></div>
...
<?php }?>
	...
	<tr>
		...
		<td rowspan=2 class=noline><input type=image src="/shop/data/skin/apple_tree/img/common/btn_login.gif" tabindex=3></td>
	</tr>
	<tr>
	...
	<table>
	<tr>
		<td rowspan=3 style="padding-right:10"><img src="/shop/data/skin/apple_tree/img/common/login_div.gif"></td>
		<td><A HREF="<?php echo url("member/join.php")?>&" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/login_04.gif"></A></td>
	</tr>
	<tr><td><A HREF="<?php echo url("member/find_id.php")?>&" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/login_05.gif"></A></td></tr>
	<tr><td><A HREF="<?php echo url("member/find_pwd.php")?>&" onFocus="blur()"><img src="/shop/data/skin/apple_tree/img/common/login_06.gif"></A></td></tr>
	</table>
	</div>
...
<div style="padding-top:15;"><img src="/shop/data/skin/apple_tree/img/common/login_03.gif" border=0></div>
<div style="border:1px solid #DEDEDE;" class="hundred">
<table width=100% cellpadding=0 cellspacing=0 border=0>
<tr>
...
<?php }else{?>
	...
	<tr><td align=center><img src="/shop/data/skin/apple_tree/img/common/login_07.gif" border=0></td></tr>
	<tr>
		<td align=center>
		...
		<tr>
			...
			<td><input type=image src="/shop/data/skin/apple_tree/img/common/btn_ok.gif"></td>
		</tr>
		</table>
