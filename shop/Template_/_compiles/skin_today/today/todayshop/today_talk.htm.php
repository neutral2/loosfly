...
<?php }else{?>
			<div class="item">
				<div class="remove" <?php if($TPL_V1["step"]> 0){?>style="padding-left:<?php echo ($TPL_V1["step"]- 1)* 10?>px"<?php }?>><?php if($TPL_V1["step"]> 0){?><img src="/shop/data/skin_today/today/img/icon_reply_arrow.gif" /> <?php }?>삭제된 글입니다.</div>
			</div>
<?php }?>
		</div>
<?php }}?>
