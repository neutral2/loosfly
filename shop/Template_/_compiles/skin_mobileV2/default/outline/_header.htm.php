<?php /* Template_ 2.2.7 2013/11/01 17:18:39 /www/loosfly_godo_co_kr/shop/data/skin_mobileV2/default/outline/_header.htm 000009054 */ 
$TPL_mobile_script_1=empty($TPL_VAR["mobile_script"])||!is_array($TPL_VAR["mobile_script"])?0:count($TPL_VAR["mobile_script"]);?>
<!DOCTYPE html>
<head>
...
<?php if($GLOBALS["cfgMobileShop"]["mobileShopLogo"]){?>
		<a href="<?php echo $GLOBALS["mobileRootDir"]?>"><img src="<?php echo $GLOBALS["cfg"]["rootDir"]?>/data/skin_mobileV2/<?php echo $GLOBALS["cfgMobileShop"]["tplSkinMobile"]?>/<?php echo $GLOBALS["cfgMobileShop"]["mobileShopLogo"]?>" alt="<?php echo $GLOBALS["cfg"]["shopName"]?>" title="<?php echo $GLOBALS["cfg"]["shopName"]?>" width="110px" height="35px"/></a>
<?php }else{?>
