<?php /* Template_ 2.2.7 2013/11/01 14:38:27 /www/loosfly_godo_co_kr/shop/data/skin_mobileV2/default/index.htm 000003077 */ ?>
...
<?php if(isset($_COOKIE['popup'])===false){?>
<div id="popup" >
...
<?php }?>
<div class="popup_btn">
	<div class="btn-today-close" onClick="javascript:closeTodayPop();">오늘하루 닫기</div>
	<div class="btn-close" onClick="javascript:closePop();">닫기</div>
</div>
</div>

</div>
<!--</xmp></div><div class="add"><xmp>오늘 하루 보이지 않음 <input type="checkbox" style="cursor:pointer; background-color:#000000;" onClick="setCookieMobile('popup', 1, 1, '/'); $('div#popup').hide();"></xmp></div><div class="add"><xmp>-->
