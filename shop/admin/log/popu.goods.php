...
if ($srunout == '1') $where[] = "g.runout = 1 OR (g.usestock = 'o' AND g.totstock < 1)";
elseif ($srunout == '-1') $where[] = "g.runout <> 1 AND (g.usestock <> 'o' OR g.totstock > 0)";
...
<tr>
	...
	<tr>
		<td valign=bottom>
		<img src="../img/sname_person.gif"><a href="javascript:sort('ea desc')"><img name=sort_ea_desc src="../img/list_up_off.gif"></a><a href="javascript:sort('ea')"><img name=sort_ea src="../img/list_down_off.gif"></a><img src="../img/sname_dot.gif"><img src="../img/sname_amount.gif"><a href="javascript:sort('cnt desc')"><img name=sort_cnt_desc src="../img/list_up_off.gif"></a><a href="javascript:sort('cnt')"><img name=sort_cnt src="../img/list_down_off.gif"></a><img src="../img/sname_dot.gif"><img src="../img/sname_sales.gif"><a href="javascript:sort('price desc')"><img name=sort_price_desc src="../img/list_up_off.gif"></a><a href="javascript:sort('price')"><img name=sort_price src="../img/list_down_off.gif"></a>
		</td>
