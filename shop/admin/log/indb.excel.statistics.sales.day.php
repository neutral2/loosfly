...
<Workbook
	...
	<Worksheet ss:Name="Sheet1">
		<Table ss:ExpandedColumnCount="9" ss:ExpandedRowCount="65535" x:FullColumns="1" x:FullRows="1">
			<Row>
				...
				<Cell ss:StyleID="sHead"><Data ss:Type="String"><?=__utf8('할인(쿠폰)')?></Data></Cell>
		...
		<? while ($row = $db->fetch($rs,1)) { ?>
			<Row>
				...
				<Cell ss:StyleID="sNum"><Data ss:Type="Number"><?=number_format($row['tot_dc'])?></Data></Cell>
