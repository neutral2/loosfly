...
<input type="hidden" name="mode" value="config">
	...
	<div class="title title_top">품절상품 표시 설정<span>모든 진열페이지에 품절표시를 설정합니다.</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=product&no=37')"><img src="../img/btn_q.gif" border="0" align="absmiddle"></a></div>
	<table class=tb style="margin-bottom:20px;">
	<col class=cellC width="120"><col class=cellL>
	<tr>
		<td>품절 표시 설정</td>
