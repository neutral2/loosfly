...
<script type="text/javascript" src="../proc/warning_disk_js.php"></script><!-- don't delete -->
...
<!-- S: 상품 재고/옵션 -->
	...
	<tr>
		...
		<td colspan="3">
			...
			<p class="help">
			0 이면 제한이 없습니다. 설정된 구매수량(최소구매수량, 최대구매수량)은 각 주문 한건에 대한 제한사항입니다.
			</p>
		</td>
	</tr>
	<tr>
...
<!-- S: 관련상품 -->
	<h2 class="title">관련상품<span>이상품과 관련있는 상품을 추천하세요 <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=product&no=3');"><img src="../img/btn_q.gif" border="0" align="absmiddle" hspace="2" /></a></h2>
...
<!-- S: 상품 이미지 -->
	<h2 class="title">상품 이미지<span>아래 자동리사이즈 되는 기능을 활용하면 더욱 편리합니다. <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=product&no=3');"><img src="../img/btn_q.gif" border="0" align="absmiddle" hspace="2" /></a></span></h2>
