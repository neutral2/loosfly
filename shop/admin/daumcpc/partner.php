...
<tr>
	...
	<div style="clear:both">
		<div style="color:#57a300;float:left;">[전체]</div>
		<div class="ver8" style="float:left;width:500px;padding:2"><?php echo $url;?></div>
		<div class="ver8" style="float:left;"><a href="../../partner/daumCpc.php" target=_blank><img src="../img/btn_naver_view.gif" align="absmiddle"></a> <img src="../img/btn_catelink_copy.gif" onclick="copy_txt('<?php echo $url;?>')"/></div>
	</div>
	</td>
</tr>
