...
<tr>
	...
	?>
	<?if($pgStatus != 'menual'){?>
	<button class="default-btn" style="padding-top:5px" onclick="methodUpdate()">결제수단 새로고침</button>
...
<tr><td style="padding-left:16"><span class=extext>- 현금 등으로 5만원 이상 결제시 소비자가 구매안전서비스의 이용을 선택할 수 있다는 사항</span></td></tr>
...
<div id=MSG03>
<table cellpadding=1 cellspacing=0 border=0 class=small_ex>
<tr><td><img src="../img/icon_list.gif" align="absmiddle"><b>전자상거래소비자보호법 및 시행령 개정에 따라 2011년 7월 29일부터 5만원 이상 현금 결제시 의무 시행됩니다.</b></td></tr>
