...
<div id="request" style="display:none;"><a href="../basic/egg.request.php"><img src="../img/btn_usafe.gif"></a></div>
...
<tr height="30">
	<td>전자보증 최소 금액</td>
	<td class="noline"><input type="text" name="min" value="<?=$egg['min']?>" style="border:1px #CCCCCC solid; width:100px;" <?=$disabled['min']?>> 원 &nbsp; <span class="extext">* 부분보증으로 서비스 개시한 경우 최소 금액을 설정합니다.</span></td>
</tr>
<tr height=30>
	<td>구매 안전 표시 설정</td>
	<td class=noline>
...
<td width=70% style='border:1px solid #cccccc;padding-left:40'><font class=extext><a href='../design/design_codi.php?design_file=outline/footer/standard.htm' target=_blank><font class=extext><b>[디자인관리 > 전체레이아웃 디자인 > 하단디자인 > html소스 직접수정]</b></font></a> 을 눌러<br> 치환코드 <font class=ver8 color=000000><b>{=displayEggBanner()}</b></font> 를 삽입하세요. <a href='../design/design_codi.php?design_file=outline/footer/standard.htm' target=_blank><font class=extext_l>[바로가기]</font></a></font></td>
</tr>
<tr>
...
<a href='../design/design_codi.php?design_file=order/order.htm' target=_blank><font class=extext><font class=extext_l>[디자인관리 > 기타페이지 디자인 > 주문하기 > order.htm]</font></a> 을 눌러<br> 치환코드 <font class=ver8 color=000000><b>{=displayEggBanner(1)}</b></font> 를 삽입하세요. <a href='../design/design_codi.php?design_file=order/order.htm' target=_blank><font class=extext_l>[바로가기]</font></a></font></td>
</tr>
</table>
</td></tr>
</table>
