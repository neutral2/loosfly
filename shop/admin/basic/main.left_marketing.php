...
### 옥션 어바웃
$partner = array();
@include_once "../../conf/auctionos.php";

$auction_useYn = $partner['useYn'];
...
<table cellpadding=0 cellspacing=0 align="center">
	<tr>
		...
		<td style="background:url('../img/m_auction_about<?php echo $auction_about;?>.gif') no-repeat; width:55px; height:72px;" onMouseOver="javascript:SubMenu2(2,'open')" onMouseOut="javascript:SubMenu2(2,'out')"><div class="best"></div>
			<div id='market_2' style='position:relative;width:0;height:0;display:none;'>
			<div style='position:absolute;filter:alpha(opacity=100);left:0;' onMouseOver="javascript:SubMenu2(2,'over')" onMouseOut="javascript:SubMenu2(2,'out')">
				<table border='0' cellpadding='0' cellspacing='0' width=160 height=62 background="../img/over_layerbox.gif">
				<tr><td style="text-align:center;color:#ffffff;font:11px Dotum;padding-top:10px;">G마켓+옥션 동시노출!<br/>매출상승!<br/>
				<a href="../auctionos/auctionos.php" target="_blank"><? if($auction_about != "_on"){?><img src="../img/btn_ad_apply.gif"><?}else{?><img src="../img/marketing_ading.gif"><?}?></a>
				</td></tr>
				</table>
			</div>
			</div>
