...
<tr>
	...
	<td class="noline">
		...
		<tr>
			...
			<tr><td height="31" background="../img/sms_bottom.gif" align="center"><font class="ver8" color="262626"><input id="el-auth-message-length" type="text" style="width:20px;text-align:right;border:0;font-size:8pt;font-style:verdana;" value="0">/80 Bytes</td></tr>
			</table>
			...
			{shopName}과 {authNum}를 포함하여 변환된 문자의 길이가 80 Bytes를 넘으면 받는 사람 문자 메세지 화면에서 일부 내용이 잘려보일 수 있습니다.
			</div>
