...
<tr>
	...
	<td>적립금</td>
	<td><?=number_format($data['emoney'])?> 원 &nbsp;&nbsp; <a href="javascript:popupLayer('../member/popup.emoney.php?m_no=<?=$data['m_no']?>',600,500)"><img src="../img/btn_detailview.gif" align="absmiddle" /></a></td>
</tr>
<tr>
	<td>최종로그인</td>
...
<tr>
	...
	<td>구입금액</td>
	<td><?=number_format( $data['sum_sale'] )?> 원 &nbsp;&nbsp; 주문 <?=number_format($data['cnt_sale'])?> 건 &nbsp;&nbsp; <a href="javascript:popup('../member/orderlist.php?m_no=<?=$data['m_no']?>',500,600)"><img src="../img/btn_detailview.gif" align="absmiddle" /></a></td>
</tr>
</table>
