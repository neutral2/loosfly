...
$res = $db->query($pg->query);
		...
		<td valign="top" colspan="10">
			...
			<td valign="top">
				...
				<tr height=23>
					<td><?=$data[couponcd]?></td>
					<td><div style="text-overflow:ellipsis;overflow:hidden;width:100px" nowrap><a href="../event/coupon_register.php?couponcd=<?=$data[couponcd]?>" target="_blank"><font class=ver71 color=0074BA><b><?=$data[coupon]?></font></a></div></td>
					<td><font class=ver71 color=444444><?
					if($data[dc]){
