...
{
	if(parent.document.forms[0].sms_type !=null) fobj = parent.document.forms[0];
	else if(parent.document.forms[1].sms_type != null) fobj = parent.document.forms[1];
	
	if(fobj.sms_type[1].checked == true){
		fobj.lms_msg.value = msg;
		fobj.lms_msg.focus();
		parent.chkLength(fobj.lms_msg);
	} else {
		fobj.sms_msg.value = msg;
		fobj.sms_msg.focus();
		parent.chkLength(fobj.sms_msg);
	}
}
