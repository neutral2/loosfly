...
<input type="hidden" name="adminAuth" value="<?=$_GET['adminAuth']?>">
	...
	<!--그룹정보-->
		...
		<td bgcolor="ffffff">
			...
			<div style="padding-left:15;padding-top:3px;float:left;width:170px"><input type="checkbox" name="menu[]" value="member" class="null" <?if($data['level'] == 100)echo"disabled";?> <?=$checked['menu']['member']?> />회원관리</div>
