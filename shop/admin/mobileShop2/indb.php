...
/*	case "setPg":
	...
	case "disp_main":
		...
		if ($_SERVER['HTTP_REFERER']) {
			...
			go("disp_main_form.php?mdesign_no=".$mdesign_no."&content_no=".$content_no, 'self');
		}
		exit;
		break;
	...
	case 'del_popup' :
		...
		$del_query = $db->_query_print('DELETE FROM '.GD_MOBILE_POPUP.' WHERE mpopup_no=[i]', $mpopup_no);
		$db->query($del_query);
