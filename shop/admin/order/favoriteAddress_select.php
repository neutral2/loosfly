<?
	...
	$pg->field = "fa_no, fa_group, fa_name, fa_email, fa_zipcode, fa_address, fa_road_address, fa_address_sub, fa_phone, fa_mobile, fa_memo";
...
<tr height="30" align="center">
	...
	<td><?=$data['fa_zipcode']." ".$data['fa_address']." ".$data['fa_address_sub']?><?if($data['fa_road_address']) { ?><div style="padding:5px 0 0 20px;font:12px dotum;color:#999;" id="div_road_address">[<?=$data['fa_road_address']." ".$data['fa_address_sub']?>]</div><? } ?></td>
	<td><?=$data['fa_email']?></td>
	<td><?=$data['fa_phone']?></td>
