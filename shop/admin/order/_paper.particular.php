...
<tr>
	...
	<tr>
		...
		<td style="padding-right: 10px" align="right" colspan="2">&nbsp;<font size="3"><?=number_format($order->getRealSettleAmount())?></font>&nbsp;<font size="3">원정</font></td>
	</tr>
	</table>
	</td>
	<!-- 공급자 -->
...
<?
$total = array(
	'etc' => $order->getRealSettleAmount(),	// 할인, 배송비 등의 합산 (=주문의 실 결제금액 - 상품가격 합)
	'supply' => 0,
	'tax' => 0,
);
...
<tr height="25">
	...
	<td align="right" style="padding-right:6px"><?=number_format($total['etc'])?></td>
	<td align="right" style="padding-right:6px"><?=number_format($total['etc'])?></td>
	<td align="right" style="padding-right:6px">0</td>
</tr>
<? } ?>
<tr height="25">
...
<tr height="25" align="center">
	...
	<td>&nbsp;</td>
	<td>합&nbsp;계</td>
	<td><?=number_format($order->getRealSettleAmount())?></td>
	<td>인수자</td>
