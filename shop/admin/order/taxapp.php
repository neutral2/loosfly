...
<tr height=25 align="center">
	<td rowspan=2 class=noline><input type=checkbox name=chk[] value="<?=$data[sno]?>" subject="주문번호 <?=$data[ordno]?>" cashreceipt="<?=$o_data[cashreceipt]?>" onclick="TAM.iciSelect(this)"></td>
