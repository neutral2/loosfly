...
<div id=MSG01>
<table cellpadding=1 cellspacing=0 border=0 class=small_ex>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">자동입금확인이란? 서비스개시일로부터 1시간 간격으로 입금내역을 조회하여 입금확인 자동처리합니다. (서비스개시일 이전 주문은 매칭안됨)</td></tr>
<tr><td height=3></td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">실시간입금확인 실행이란? 자동이 아닌 운영자가 직접 수동으로 입금확인처리를 실행합니다.
<div style="padding-left:143">입금내역건수가 많은 경우, 자동처리되는 1시간 간격보다 빠르게 입금확인처리를 하려는 경우에 사용하세요.</div>
<div style="padding-left:143">조회항목에서 입금일을 조정하고 '실시간입금확인실행' 버튼을 누르면 수동으로 입금확인을 처리합니다.</div></td></tr>
<tr><td height=3></td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">통장입금내역 실시간 조회: 입금일을 기준으로 입금확인된 내역을 조회합니다. 단순히 조회만 하는 기능입니다.</td></tr>
<tr><td height=3></td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">자동입금확인 서비스 (손대지않아도 자동으로 처리)</font>
<ol type="a" style="margin:0px 0px 0px 40px;">
<li>내 쇼핑몰 은행계좌들의 입금내역과 주문내역을 자동으로 비교하여 통장에 입금된 내역을 자동으로 입금확인처리하는 서비스입니다.</li>
<li>비교(Matching) 범위 : 기본적으로 7일간의 입금내역과 37일간의 주문내역을 조회하여 매칭작업합니다.</li>
<li>비교(Matching) 기준 : 은행, 계좌번호, 금액, 입금자명으로 매칭작업합니다.</li>
<li><b>동일주문의 경우</b> : 은행, 계좌번호, 금액, 입금자명이 동일한 주문의 경우 '동명이인' 으로 처리되며, 반드시 수작업으로 입금확인처리해야 합니다</li>
<li>비교(Matching) 주기 : 1시간 간격으로 자동처리합니다.</li>
</ol>
</td></tr>
<tr><td height=3></td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">실시간입금확인 실행하기 (직접 수동으로 처리)
<ol type="a" style="margin:0px 0px 0px 40px;">
<li>입금내역과 주문내역의 비교(Matching)를 수동으로 실행처리합니다.</li>
<li>비교(Matching) 범위 : 입금일 검색항목 기간의 입금내역과 +30일간의 주문내역을 조회하여 매칭작업합니다. (기본범위는 7일간의 입금내역, 입금일을 조정하여 수동처리가 가능)</li>
<li>비교(Matching) 기준 : 자동입금확인 서비스와 동일</li>
</ol>
</td></tr>
<tr><td height=3></td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">위 서비스를 이용하시려면 '계좌통합관리' 메뉴를 통해 서비스를 신청하신 후 은행계좌들을 등록하셔야 합니다.</td></tr>
</table>
</div>
