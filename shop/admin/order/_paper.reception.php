<?
	...
	//네이버 마일리지 및 캐쉬 사용 금액 제외
	if($order['ncash_emoney']) $item_price = $item_price - $order['ncash_emoney'];
	if($order['ncash_cash']) $item_price = $item_price - $order['ncash_cash'];
...
<? for($loop=0; $loop < 2; $loop++){ ?>
	...
	<tr align=middle>
		...
		<td style="border-left-width: 3px; border-right-width: 3px; border-bottom-width: 4px;">&nbsp;￦<?=number_format($order->getRealSettleAmount())?></td>
		<td align=right></td>
	</tr>
	</table>
