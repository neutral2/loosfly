...
if ($data['errmsg']){
	$status = '<span class="red hand" onclick="alert(\''.$data['errmsg'].'\')">'.$status.'</span>';
}
...
<tr>
	<td>로그</td>
	<td colspan="3"><textarea style="width:100%;overflow:visible;font:9pt 굴림체;padding:10px 0 0 8px"><?=trim($data['receiptlog'])?></textarea></td>
</tr>
</table>
