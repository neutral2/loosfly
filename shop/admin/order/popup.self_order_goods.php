...
<form class="admin-form" method="get" name="frmList" id="el-admin-goods-search-form">
	...
	<tr>
		...
		<td>
			<?
			$price = (array)Clib_Application::request()->get('price');
			?>
			<input type=text name=price[] value="<?=$price[0]?>" onkeydown="onlynumber()" size="15" class="ar"> 원 -
			<input type=text name=price[] value="<?=$price[1]?>" onkeydown="onlynumber()" size="15" class="ar"> 원
		</td>
		<th>브랜드</th>
		<td>
