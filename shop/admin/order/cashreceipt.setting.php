...
$pgs = array('inicis' => '이니시스', 'inipay' => '이니시스', 'allat' => '올앳', 'dacom' => '데이콤', 'lgdacom' => 'LG데이콤','easypay'=>'이지페이');
...
$cashreceipt->autoApproval('1227499419629');
?>
...
<tr>
	...
	현금영수증 발급 금액에는 배송비는 포함되고, 적립금 사용액은 포함되지 않습니다.
...
<tr>
	...
	<span class="small4" style="color:#6d6d6d">(구매자가 마이페이지에서 영수증을 직접 발급합니다.-기존방식)</span>
	</div>
	<div>
...
<tr>
	...
	<td>
	<div>
	<input type="radio" name="set[receipt][order]" value="N" class="null" <?=$checked['order']['N']?>> 마이페이지
	<span class="small4" style="color:#6d6d6d">(마이페이지에서만 현금영수증을 신청합니다.)</span>
	</div>
	<div>
	<input type="radio" name="set[receipt][order]" value="Y" class="null" <?=$checked['order']['Y']?>> 주문서+마이페이지
...
<tr>
	...
	<td>
	<div>
	<input type="radio" name="set[receipt][auto]" value="Y" class="null" <?=$checked['auto']['Y']?>> 자동발급
	<span class="small4" style="color:#6d6d6d">(구매자가 현금영수증을 신청하면 입금확인/취소완료 단계에서 자동으로 발급/취소됩니다.)</span>
	</div>
	<div>
	<input type="radio" name="set[receipt][auto]" value="N" class="null" <?=$checked['auto']['N']?>> 수동발급
	<span class="small4" style="color:#6d6d6d">(관리자가 건별로 발급버튼을 눌러서 발급합니다.)</span>
	</div>
	</td>
</tr>
<tr>
...
<tr>
	<td><img src="../img/icon_list.gif" align="absmiddle">현금영수증 제도는 소비자에게는 소득공제를, 가맹점에게는 세액공제의 혜택을 주며<br>
	&nbsp; 건전한 소비문화 정착과 조세정의 실현을 위해 2005년 1월 1일부터 시행 되는 제도입니다.
	</td>
</tr>
<tr>
	<td><img src="../img/icon_list.gif" align="absmiddle">현금영수증 제도의 혜택을 받기 위해서 소비자는 현금(무통장입금) 구매시 판매자(현금영수증 가맹점)에게 현금영수증 발급을 요청한 후,<br>
	&nbsp; 본인확인이 가능한 휴대전화 번호 등을 제시해야 합니다.
	</td>
</tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">현금영수증 발급대상금액은 2008년 7월 1일부터 5,000원 미만 현금결제로 확대되어 1원 이상이면 발급됩니다.</td></tr>
<tr><td><img src="../img/icon_list.gif" align="absmiddle">현금영수증 관련 거래내역은 익일에 국세청홈페이지 <a href="http://현금영수증.kr" target="_blank"><b>http://현금영수증.kr</b></a>에서 확인할 수 있습니다.</td></tr>
