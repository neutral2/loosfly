...
<tr>
	...
	<td colspan=3 class=noline><font class=small1 color=5C5C5C>
	<input type=checkbox name=chk_inflow[] value="naver" <?=$checked[chk_inflow][naver]?>><img src="../img/inflow_naver.gif" align=absmiddle> 네이버지식쇼핑&nbsp;
...
<tr height=25 bgcolor="<?=$bgcolor?>" bg="<?=$bgcolor?>" align=center>
	...
	<b><?=$data[nameOrder]?></b><? if ($data[m_id]){ ?> (<?=$data[m_id]?>)</font><? if ($data[m_id]) { ?></span><? } ?>
	<? } ?>
	</td>
