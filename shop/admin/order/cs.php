...
<tr bgcolor="<?=$bgcolor[$data['istep']]?>" height="25">
	...
	<td align="center"><span class="small1" style="color:#444444"><?=$data['settlekind']?></span></td>
...
<tr bgcolor="<?=$bgcolor[$data['istep']]?>" height="25">
	...
	<td align="center">
	<? if ($data[m_id]){ ?><span id="navig" name="navig" m_id="<?=$data['m_id']?>" m_no="<?=$data['m_no']?>"><span class="small1" style="color:#0074BA"><?=$data['nameOrder']?></span></span>
	<? } else { ?><span class="small1"><?=$data['nameOrder']?></span>
	<? } ?>
	</td>
	<td style="padding-left:10px">
	<span class="small1" style="color:#444444">
	...
	<td align="center"><span class="ver71" style="color:#444444"><?=$data['sea']?></span></td>
	<td align="center"><span class="small1" style="color:#444444"><?=$r_settlekind[$data['settlekind']]?></span></td>
	<td align="center"><span class="ver71"><b><?=number_format($data['pay'])?><b></span></td>
	<td align="center">
