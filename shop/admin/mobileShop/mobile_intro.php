...
<tr>
	<td class="noline">
		<label><input type="radio" name="custom_landingpageMobile" value="2" <?=$cfg['custom_landingpageMobile'] == 2 ? 'checked' : ''?> <?=!$adultro_ready ? 'disabled' : ''?> />메인페이지 접속이 성인만 접근 가능한 인트로 페이지</label><br>
