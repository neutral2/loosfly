...
<tr>
	...
	<td>
		...
		<div><font class=small1>전체배경이미지</font> <input type="file" name="outbg_img_up" size="50" style="width:150" class="line"><input type="hidden" name="outbg_img" value="<?=$data_file['outbg_img']?>">
			<a href="javascript:webftpinfo( '<?=( $data_file['outbg_img'] != '' ? '/data/skin/' . $cfg['tplSkinMobileWork'] . '/img/codi/' . $data_file['outbg_img'] : '' )?>' );"><img src="../img/codi/icon_imgview.gif" border="0" alt="이미지 보기" align="absmiddle"></a>
	...
	<td>
		...
		<div><font class=small1>배경이미지</font>
			...
			<a href="javascript:webftpinfo( '<?=( $data_file['inbg_img'] != '' ? '/data/skin/' . $cfg['tplSkinMobileWork'] . '/img/codi/' . $data_file['inbg_img'] : '' )?>' );"><img src="../img/codi/icon_imgview.gif" border="0" alt="이미지 보기" align="absmiddle"></a>
