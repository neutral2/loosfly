...
<tr>
	...
	<input type=checkbox name=set[use_mobile][h] <?=$checked[h]?> onclick="chkSettleKind()"> 핸드폰
...
<tr>
	...
	<td class=ver8><input type=file name=pg[file_0<?=$i?>] class=lline disabled="disabled"> <?=$fls[pg][$i-1]?></td>
</tr>
<? } ?>
<tr>
