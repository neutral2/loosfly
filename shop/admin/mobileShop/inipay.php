...
<tr>
	<td>결제수단 설정</td>
	<td class="noline">
		<input type="checkbox" name=set[use_mobile][c] <?php echo $checked['c'];?> onclick="chkSettleKind();" /> 신용카드
		<input type="checkbox" name=set[use_mobile][v] <?php echo $checked['v'];?> onclick="chkSettleKind();" /> 가상계좌
		<input type="checkbox" name=set[use_mobile][h] <?php echo $checked['h'];?> onclick="chkSettleKind();" /> 핸드폰
...
<tr>
	...
	<td class="ver8"><input type="file" name="pg[file_0<?php echo $i;?>]" class="lline" disabled="disabled" /> <?php echo $fls['pg'][$i-1];?></td>
</tr>
<?php } ?>
<tr>
