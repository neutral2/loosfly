...
<tr>
	...
	<td>조건</td>
	<td class="noline">
		<input type="radio" name="condition_type" value="straight" id="rdo_condition_type_straight"  >매일 출석형 - 출석체크기간동안 매일 
		<input type="text" name="condition_period" size="3" style="border:1px solid #cccccc" id="ipt_straight_period">일 
		이상 출석하면 혜택을 제공한다<br>
		<input type="radio" name="condition_type" value="sum" id="rdo_condition_type_sum">횟수 출석형 - 출석체크기간동안 
