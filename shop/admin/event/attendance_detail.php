...
<tr><td height="4" colspan="12"></td></tr>
<tr height="25">
	<td><font class="ver81" color="#616161"><input type="checkbox" style="border-width:0px" name="check_no[]" value="<?=$v['check_no']?>" <?=$v['checkbox_status']?>></font></td>
	...
	<td><font class="ver81" color="#616161">
		<a href="javascript:popupLayer('../member/popup.emoney.php?m_no=<?=$v['m_no']?>',600,500)">
			<img src="../img/btn_pointview.gif">
		</a>
	</font></td>
</tr>
<? endforeach; ?>
