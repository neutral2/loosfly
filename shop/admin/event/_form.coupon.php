...
<tr>
	...
	<div id=priodid0 style="display:none;">
		<input type=text name=sdate value="<?=$data[sdate]?>"  class=line> - <input type=text name=edate value="<?=$data[edate]?>"  class=line>	<font class=extext> ex) 2007-09-10 12:30:30</font>  <font class=extext>&nbsp;시간까지 정확히 입력하세요</font>
	</div>
	<div id=priodid1 style="display:none;">
		...
		&nbsp; 사용 가능일을 <input type=text name=priod_edate value="<?=$data[edate]?>"  class=line> 로 제한합니다. 입력하지 않을 경우 제한이 없습니다.<font class=extext> ex) 2007-09-10 12:30:30</font> <font class=extext>&nbsp;시간까지 정확히 입력하세요</font>
	</div>
	</td>
</tr>
<tr>
...
<tr>
	...
	<input type=radio name="payMethod" value="1" class=null <?=$checked['payMethod'][1]?>> 무통장 입금에서만 사용가능</td>
</tr>
</table>
