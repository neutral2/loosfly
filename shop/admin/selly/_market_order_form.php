...
<tr>
	...
	<td width=100%><a href="<?=str_replace('{mall_goods_cd}', $row_market_order['mall_goods_cd'], $mall_goods_url[$row_market_order['mall_cd']])?>" target="_blank"><?=htmlspecialchars($row_order_item['goodsnm'])?></a></td>
