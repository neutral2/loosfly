...
<div class="title title_top">개인정보취급방침 및 전자적표시<span><font class="small">전자적표시를 작성하고 해당 파일(p3p.xml, p3policy.xml)을 업로드합니다.</span></div>
...
<div style="padding-top:12px"><font color="ea0095">&#149; 전자적 표시란?</font></div>
<div style="padding-top:3px" class="small1">개인정보취급방침의 내용 및 형식을 규격화하여 이용자가 눈으로 읽을 필요 없이 소프트웨어를 통해 자동으로 읽혀질 수 있도록 만든 것으로, 정보통신망법에서는 2007년 7월 27일부터 웹 사이트에 개인정보 취급방침을 공개하는 경우에 전자적 표시를 반드시 함께 표시하도록 규정하고 있습니다.</div>
...
<div style="padding-top:3px" class="small1"> - 가이드 및 작성예시 : <a href="http://www.i-privacy.kr/jsp/user/private/prv_plan1.jsp" target="_blank"><font color="#0074BA"><b><u>http://www.i-privacy.kr/jsp/user/private/prv_plan1.jsp</u></b></font></a></div>
...
<div style="padding-top:12px"><font color="ea0095">&#149; 개인정보취급방침 및 전자적표시 작성방법. (아래 주소를 클릭하셔서 작성하세요) </font></div>
<div style="padding-top:3px" class="small1"> - <a href="http://www.checkprivacy.co.kr/main.jsp" target="_blank"><font color="#0074BA"><b><u>작성하기</u></b></font></a></div>
...
<div class="title title_top">전자적표시 설정<span><font class="small">전자적표시를 작성하고 해당 파일(p3p.xml, p3policy.xml)을 업로드합니다.</span></div>

<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#fafafa">
<tr><td style="padding: 15px 15px 15px 15px; text-align: justify">
<div><font color="#EA0095">&#149; 업로드 방법</font><div>
<div style="padding-top:3px" class="small1">'개인정보취급방침 및 전자적표시 작성방법'에서 작성후 다운로드 받은 2개의 파일을 아래에서 등록 후 저장합니다.</div>
<div style="padding-top:3px" class="small1">파일은 각각 <font class="ver8" color="#0074BA"><b>p3p.xml, p3policy.xml</b></font> 입니다. 순서에 상관없이 등록하세요.</div>
<?=$w3cDirChk?>
</td></tr></table>
<table class="tb">
<col class="cellC"><col class="cellL">
...
<tr>
	...
	<? if($fls[w3c][$i-1]){ ?>
	<span class="noline"><input type="checkbox" name="w3cDel[file_0<?=$i?>]" value="Y" />삭제</span> <?=$fls[w3c][$i-1]?>
