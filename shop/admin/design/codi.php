...
<tr>
	...
	<tr>
		...
		<td width=1></td>
		<td><a href="iframe.codi.php?design_file=goods/goods_view.htm&" target="ifrmCodi"><img src="../img/btn_q_delinfo.gif"></a></td>
	</tr>
	<tr><td height=4 colspan=5></td></tr>
	<tr>
...
<table>
	...
	<? else: ?>
		<iframe id=ifrmCodi name=ifrmCodi src="<?=($_GET['design_file'] ? '../../blank.php' : '../design/iframe.default.php')?>" style="width:100%;height:500px;" frameborder=0></iframe>
	<? endif; ?>
