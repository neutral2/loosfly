...
<tr>
	...
	<a href="javascript:webftpinfo( '<?=( $data['img'] != '' ? '/data/skin/' . $cfg['tplSkinWork'] . '/img/banner/' . $data['img'] : '' )?>' );"><img src="../img/codi/icon_imgsizeview.gif" border="0" alt="이미지 보기" align="absmiddle"></a>
	<? if ( $data['img'] != '' ){ ?>&nbsp;&nbsp;<span class="noline"><input type="checkbox" name="img_del" value="Y">삭제</span><? } ?>
	<? if ( $data['img'] != '' ){ echo '<div style="margin-top:3px;">' . $webftp->confirmImage( "../../data/skin/" . $cfg['tplSkinWork'] . "/img/banner/" . $data['img'],300,100,"0") . '</div>'; }?> </td>
</tr>
</table>
