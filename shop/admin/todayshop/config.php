...
<div style="width:100%">
	<form name="frmConfig" method="post" action="indb.config.php" target="ifrmHidden" />
		...
		<tr>
			<td>SMS사용 설정</td>
			<td class="noline">
				<label><input type="radio" name="useSMS" value="y" <?=$checked['useSMS']['y']?> />사용</label>
				<label><input type="radio" name="useSMS" value="n" <?=$checked['useSMS']['n']?> />미사용</label>
				<span class="small"><font class="extext">친구에게 알리기 SMS사용여부를 설정 합니다.</font></span>
			</td>
		</tr>
		<tr>
			<td>적립금 결제 사용</td>
...
<div style="clear:both;" id=MSG01>
	...
	<tr>
		<td>
			...
			<div>&nbsp;</div>
			<div>● SMS사용 설정 : 메인 화면 친구에게 알리기의 SMS 사용 여부 설정 기능 입니다.</div>
			<div>사용안함으로 설정 할 경우 이 아이콘은 노출되지 않습니다. </div>
			<div>SMS기능은 포인트 충전식으로 포인트가 있어야만 사용할 수 있습니다.</div>
			<div><a href="../member/sms.pay.php" target="_blank"><font class="extext_l">회원>SMS설정>SMS 포인트 충전</font></a>에서 충전하여 이용하실 수 있습니다.</div>
			<div>&nbsp;</div>
