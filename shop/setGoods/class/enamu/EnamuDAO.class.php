...
class EnamuDAO{
	...
	function EditGoodsList($val,$sp,$st,$pg='0',$listNum='0'){
		...
		$query  = "SELECT DISTINCT a.goodsno as goodsno, a.goodsnm as goodsnm, a.img_s as img_s,a.img_l as img_l, a.open as open, a.regdt as regdt, b.price as price, b.reserve as reserve, a.use_emoney as use_emoney ";
		$query .= "FROM ".GD_GOODS." a ";
		...
		if($val != '')$query .= "AND category LIKE'".$val."%' ";
