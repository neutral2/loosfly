...
class codyContent {
	...
	function Content($tpl){
		...
		$args = array('shopnm'=>$this->Edao->cfg['shopName'], 'goodsnm'=>$objs->get('cody_name'), 'goodsurl'=>$goodsurl, 'img'=>"http://".$_SERVER['HTTP_HOST']."/setGoods/data/Tnail/200/200_".$objs->get('thumnail_name'));
