	...
	switch ($_GET[type]){
		...
		case "goods" :
			if($_GET[category]){
				...
				$pg->cntQuery = "select count(distinct a.goodsno) from ".GD_GOODS_LINK." a,".GD_GOODS." b where a.goodsno=b.goodsno  and category like '$_GET[category]%' and open";
				...
				";
				$where[] = "a.category like '$_GET[category]%'";
				$where[] = "open";
